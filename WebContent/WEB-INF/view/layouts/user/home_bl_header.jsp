                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <div class="logo">
                                <h1><a href="home" title="Nook and Cove"><img src="resources/images/logo.png" alt="nookandcove" style="vertical-align: middle; margin-top: 12px;"></a></h1>
                            </div> <!-- /.logo -->
                        </div> <!-- /.col-md-2 -->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <!-- <div class="menu text-center hidden-sm hidden-xs">
                                <ul>
                                    ...
                                    <li><a href="home"><font class="reg_header_text_bcdsp">THE REGISTRY</font></a></li>                                    
                                </ul>
                            </div> -->
                        </div> <!-- /.col-md-6 -->                        
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="menu text-right hidden-sm hidden-xs">
                                <ul>
                            		<!-- <li><a href="getStartedBuss">START A PROJECT</a></li> -->
