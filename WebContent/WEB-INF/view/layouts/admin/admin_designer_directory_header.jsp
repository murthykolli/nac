...
<head>
    ...
    <script src="resources/js/main_js/modernizr.js"></script>
    <!--[if lt IE 8]>
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            <div class="menu text-left hidden-sm hidden-xs after_login_header_adj">
                                <ul>
                                    ...
                                    <li class="current"><a href="admDesnDirectory">DESIGNER DIR</a>
                        ...
                        <a href="#" class="toggle-menu fa fa-bars"></a>
                        	<div class="menu">
                            	<ul>
                                    ...
                                    <li><a href="admClientDirectory">CLIENT DIR</a></li>
                                    <li class="current"><a href="admDesnDirectory">DESIGNER DIR</a></li>
                                    <li><a href="promoCodeDisplay">PROMO</a></li>
