                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            <div class="menu text-left hidden-sm hidden-xs after_login_header_adj">
                                <ul>
                                    ...
                                    <li><a href="admnPurchases">PURCHASES</a>
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <div class="menu text-right hidden-sm hidden-xs">
                                <ul>
                            		...
                            		<li style="display: none;" id="adminAccountsDspId"><a href="admnAccounts"><img src="resources/images/admin/accountsMO.png" title="Accounts" onmouseover="this.src='resources/images/admin/accounts.png'" onmouseout="this.src='resources/images/admin/accountsMO.png'" border="0"></a></li>
                        ...
                        <a href="#" class="toggle-menu fa fa-bars"></a>
                        	<div class="menu">
                            	<ul>
                                    ...
                                    <li><a href="admnPurchases">PURCHASES</a></li>            
                                </ul>
