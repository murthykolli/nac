                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            <div class="menu text-left hidden-sm hidden-xs after_login_header_adj">
                                <ul>
                                	<li><a href="registryLiveStatusRed"> &nbsp;&nbsp; LIVE STATUS &nbsp;&nbsp; </a></li>
                                	<li><a href="regConceptBoards"> &nbsp;&nbsp; THE REGISTRY &nbsp;&nbsp; </a></li>
                                    <li><a href="adminShopPurchases"> &nbsp;&nbsp; Shop &nbsp;&nbsp; </a></li>
                                    <li><a href="adminNewApplicants"> &nbsp;&nbsp; REFERRAL PROGRAM &nbsp;&nbsp; </a></li>
                                    <!-- <li><a href="adminStockCheckPriceUpdate"> &nbsp;&nbsp; PRICE UPDATE &nbsp;&nbsp; </a></li> -->
                                    
                                	<!-- <li><a href="adminPRHome"> &nbsp;&nbsp; HOME &nbsp;&nbsp; </a></li>
                                	<li><a href="admNewClients"> &nbsp;&nbsp; THE DESIGN PROCESS &nbsp;&nbsp; </a></li>
                                    <li><a href="regConceptBoards"> &nbsp;&nbsp; THE REGISTRY &nbsp;&nbsp; </a></li>
                                    <li><a href="adminShopPurchases"> &nbsp;&nbsp; SHOP &nbsp;&nbsp; </a></li> -->
                        ...
                        <a href="#" class="toggle-menu fa fa-bars"></a>
                        	<div class="menu">
                            	<ul>
                                    ...
                                    <!-- <li><a href="admDesnAndRegistryHome">HOME</a></li>
                                	<li><a href="admNewClients">THE DESIGN PROCESS</a></li>
                                    <li><a href="regConceptBoards">THE REGISTRY</a></li>
                                    <li><a href="adminShopPurchases"> &nbsp;&nbsp; SHOP &nbsp;&nbsp; </a></li> -->           
                                </ul>
