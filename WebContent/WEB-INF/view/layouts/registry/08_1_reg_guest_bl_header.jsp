                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            <div class="menu text-right hidden-sm hidden-xs">
                                <ul>
                            		...
                            		<li>&nbsp;
									<a href="regGuestMyShoppingCart"><img src="resources/images/payment_cart_img.jpg" alt="shoppingcart"> <font id="roundShapId"><span id="regCartValueDisp" style="display: none;"><font id="guestCartDspId">${cartCountInSn}</font></span></font></a>
									</li>
                                </ul>
                            </div> <!-- /.menu -->
                        </div> <!-- /.col-md-8 -->
                    ...
                    <%-- <div class="responsive-menu text-right visible-xs visible-sm">
                        ...
                        <div class="menu">
                            <ul>
                            	...
                            	<li class="current"><a href="guestRegistryMyAccount">&nbsp;&nbsp;GIVE A GIFT&nbsp;&nbsp;</a></li>
                            	<li>&nbsp;
								<a href="regGuestMyShoppingCart"><img src="resources/images/payment_cart_img.jpg" alt="shoppingcart"> <font id="roundShapId"><span id="mobCartValueDisp" style="display: none;"><font id="guestCartMobDspId">${cartCountInSn}</font></span></font></a>
								</li>
                          	</ul>
                        </div>
                    </div> --%> 
