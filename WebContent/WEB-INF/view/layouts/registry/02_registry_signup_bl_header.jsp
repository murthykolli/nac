...
<head>
	...
	<body style="overflow-x: hidden">
		<div id="home"> <div class="site-header"> <div class="top-header" > </div> 
        <div class="main-header"> <div class="container"> <div class="row"> <div class="col-md-4 col-sm-4 col-xs-4">
        <div class="logo"> <h1><a href="home" title="Nook and Cove Registry"> <img src="resources/images/logo.png" alt="NookandCove Logo"> <font class="reg_logo_text_font desktop">Shop &amp; Registry</font> </a></h1> </div> </div> 
        <div class="col-md-8 col-sm-8 col-xs-8"> <div class="menu text-right hidden-sm hidden-xs">
        <ul> <li><a href="registryShop">&nbsp;SHOP&nbsp;</a></li>
		...
		<ul class="dropdown_sub_menu"> <li><a href="registryHowItWorks" style="text-align: left; position: relative; left: -54px; top: 0px;">&nbsp;HOW IT WORKS&nbsp;</a></li>
		<li><a href="registryBenefits" style="text-align: left; position: relative; left: -14px; top: 5px;">&nbsp;REGISTRY BENEFITS&nbsp;</a></li>
		<li><a href="lmDesignServices" style="text-align: left; position: relative; left: -34px; top: 10px;">&nbsp;DESIGN SERVICES&nbsp;</a></li> </ul> </li>
        <li><a href="registryLogin">&nbsp;&nbsp;&nbsp;&nbsp;SIGN IN</a>&nbsp;</li>
        <li class="current"><a href="createRegistry">SIGN UP</a></li> </ul> </div> </div> </div> </div> </div> </div> </div>
