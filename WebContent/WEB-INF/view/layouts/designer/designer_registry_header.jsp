...
<head>
    ...
    <script type="text/javascript">	
 	$(document).ready(function(){
 		var desnMessageSt = "<c:out value="${adminMessageCount}"/>";
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="menu text-left hidden-sm hidden-xs after_login_header_adj">
                                <ul>
                                    ...
                                    <li class="current"><a href="designerRegConceptBoards">REGISTRY</a></li>                                                          
                                </ul>
                                <div class="mess_admin_new_img_ds" id="adminMessgeId" style="display: none;"><img src="resources/images/designer/desn_new_img.png"></div>
                            </div> <!-- /.menu -->
                        </div> <!-- /.col-md-7 -->                        
