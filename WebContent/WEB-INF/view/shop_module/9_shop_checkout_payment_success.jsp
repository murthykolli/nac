...
<html>    
	...
	.reg_home_Butn_dspl:hover { background-color: #2c2c2c; }
		...
		<body>		
		<div id="mainframe" class="section-content"> <div class="container"> <div class="row"> <div class="col-md-12 col-sm-12" style="margin-left: 30px;">	    
		...
		<div align="left" class="order_number_text_dsp"><font class="order_number_first_text_dsp">O</font>RDER <font class="order_number_first_text_dsp">N</font>UMBER:&nbsp;${shopPaymentOrderNumber}</div> </div> </div> </div> </div>			
<!-- Cart Total Value Code -->	
		...
		<% 
			session.setAttribute("shopCBProductCartValueListInSn", null); session.setAttribute("totalPaybleAmountForEmailInSn", null);
		%>        				          
        </div> </div>        
		</body>
</html>