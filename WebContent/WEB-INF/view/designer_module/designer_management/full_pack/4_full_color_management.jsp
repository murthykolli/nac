        ...
        <div class="col-md-5 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<div class="desn_top_cl_frm_dis"><input type="text" name="typeOfColor" readonly class="mod_cl_input"></div>
        			<div class="margin_top_adj_dis"><div class="top_on_input_box_text_dis">COLORS I LOVE: </div></div>
        			<div><textarea name="likeColor" readonly id="likeColorId" placeholder="COLORS I LOVE" class="desn_item_txt_input_boxs_dis" style="margin-top: 10px;"></textarea></div>
        			<div class="margin_top_adj_dis"><div class="top_on_input_box_text_dis">COLORS I DISLIKE: </div></div>
        			<div><textarea name="dislikeColor" readonly id="dislikeColorId" placeholder="COLORS I DISLIKE" class="desn_item_txt_input_boxs_dis" style="margin-top: 10px; margin-bottom: 40px;"></textarea></div>
        			</div>
