	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		var moreAbSpace = '<c:out value="${moreAboutSpace}"/>';
 	        ...
 	        var str = "<td> <img src=" + imageFormat + " alt='' class='adminViewImgDsp inspiredImgs uploadImgs' style='cursor: pointer;'> </td>";
 	        tab1.append(str);       
 	        }
 	        }        
            	...
            	<div class="service-description">
        			<div align="center" class="quest_bord_frame">
        				<div align="left" class="cl_imgs_list1_dsp">       	
				        	<table id="clSpaceImg1List"></table>
				        </div>
				        
				        <div align="left" class="cl_imgs_list2_dsp">       	
				        	<table id="clSpaceImg2List"></table>
				        </div>
        				<div class="margin_top_adj_dis"><div class="top_on_input_box_text_dis">I NEED MY SPACE TO BE PET FRIENDLY: </div></div>
        				<textarea name="moreAboutSpace" id="moreAboutSpaceId" placeholder="I NEED MY SPACE TO BE PET FRIENDLY ..." readonly class="desn_item_txt_input_boxs_dis" style="margin-top: 10px; margin-bottom: 40px;"></textarea>
