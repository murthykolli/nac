            	...
            	<div class="service-description">
        			<div align="center" class="quest_bord_frame">
        				<div align="left" class="cl_imgs_list1_dsp">       	
				       		<table id="clShInspImg1List"></table>
				    	</div>
				        
				        <div align="left" class="cl_imgs_list2_dsp">       	
				        	<table id="clShInspImg2List"></table>
				        </div>
				        <div class="margin_top_adj_dis"><div class="top_on_input_box_text_dis">PINTEREST BOARD URL: </div></div>
        				<textarea name="shareInspiration" id="shareInspirationId" readonly placeholder="PINTEREST BOARD URL" class="desn_item_txt_input_boxs_dis" style="margin-top: 10px; margin-bottom: 40px;"></textarea>
        			</div>
