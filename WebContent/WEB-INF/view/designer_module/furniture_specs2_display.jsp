...
<html>
    ...
    $(document).ready(function(){    	        
        $("#insured_list tr").not(':first').hover(
    		    function () {
    		    if(!$(this).find("input[name='furnSpec2RefId']").is(':checked')){
    		    ...
    		    $(this).find("input[name='furnSpec2RefId']").prop("checked",true);
    		    });
    ...
    element.innerHTML = pagerHtml;
		...
		<form action="furnitureSpecs2DataSavingInDB" name="fileUpload" method="post" enctype="multipart/form-data">
		<div align="center" style="margin-top: 30px; margin-left: 0px;"><font class="mainHeaddings" style=" border-bottom: 1px solid red; padding-bottom: 5px;">&nbsp;&nbsp;CONCEPT #2 FURNITURE SPECS&nbsp;&nbsp;</font></div>
        ...
        <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="furnSpec2RefId" value="${insured_list.clientProductsUploadedByDesignerSavingId}"/><span></span></label>
        </display:column>
        ...
        function deleteProducts(){
	        ...
	        var furnSpec2RefIds="";        
		        for(var k=0; k < document.fileUpload.furnSpec2RefId.length; k++) {
			        if(document.fileUpload.furnSpec2RefId[k].checked){
			        	furnSpec2RefIds=document.fileUpload.furnSpec2RefId[k].value;        
			        }
		        }
	    
	        if(document.fileUpload.furnSpec2RefId.checked){
	        	furnSpec2RefIds=document.fileUpload.furnSpec2RefId.value;
	        }
