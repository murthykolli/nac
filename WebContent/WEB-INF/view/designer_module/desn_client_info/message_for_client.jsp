...
<html>    
	...
	<script type="text/javascript">
	  $(document).ready(function() {
	    $("#designerMessageForAdminId").emojioneArea({searchPosition: "right"});
	  });
	</script> -->
        ...
        <div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	...
            	<div class="mess_head_tx_dspl">${clientName}</div>
            		<div>   
				  ...
				  <div class="message_type_display_box_cl">			
						<form action="designerMessageSendToClient" name="messageSending" method="post">
						<textarea  name="designersMessage" id="designerMessageForAdminId" class="entry" placeholder="Type message here" style="font: 1.15em/1.25em Georgia; color: black; height: 108px;"></textarea>
		...
		document.messageSending.elements['designersMessage'].focus();
