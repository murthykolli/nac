...
<html>    
    ...
    $("[name=desigerNotes]").val(desigerNotes1);
        ...
        <form action="designerNotesDataSaving" method="post">
        <div class="row">
		...
		<a href="accStyleManagement"><img class="back_submit_Btn" style="margin-right: -7px;" src="resources/images/backButton.png"></a>
		</div>
