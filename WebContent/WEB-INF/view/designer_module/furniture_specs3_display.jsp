...
<html>
    ...
    $(document).ready(function(){    	        
        $("#insured_list tr").not(':first').hover(
    		    function () {
    		    if(!$(this).find("input[name='furnSpec3RefId']").is(':checked')){
    		    ...
    		    $(this).find("input[name='furnSpec3RefId']").prop("checked",true);
    		    });
    ...
    element.innerHTML = pagerHtml;
		...
		<form action="furnitureSpecs3DataSavingInDB" name="fileUpload" method="post" enctype="multipart/form-data">
		<div align="center" style="margin-top: 30px; margin-left: 0px;"><font class="mainHeaddings" style=" border-bottom: 1px solid red; padding-bottom: 5px;">&nbsp;&nbsp;CONCEPT #3 FURNITURE SPECS&nbsp;&nbsp;</font></div>
        ...
        <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="furnSpec3RefId" value="${insured_list.clientProductsUploadedByDesignerSavingId}"/><span></span></label>
        </display:column>
        ...
        function deleteProducts(){
	        ...
	        var furnSpec3RefIds="";        
		        for(var k=0; k < document.fileUpload.furnSpec3RefId.length; k++) {
			        if(document.fileUpload.furnSpec3RefId[k].checked){
			        	furnSpec3RefIds=document.fileUpload.furnSpec3RefId[k].value;        
			        }
		        }
	    
	        if(document.fileUpload.furnSpec3RefId.checked){
	        	furnSpec3RefIds=document.fileUpload.furnSpec3RefId.value;
	        }
