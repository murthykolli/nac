    ...
    $("#furnitureSpecsEditButId").click(function(){
        ...
        <div class="col-md-6 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="center">
        			<p class="prod_uplod_rm_ren_disp_mana_for_Dsn">Final Concept - FURNITURE SPECS</p>
        			</div>
        ...
        <div class="col-md-2 col-sm-2">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="furnitureSpecsAccPackDisplayBackMove"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>
        ...
        <div class="col-md-6 col-sm-6">
	        <div class="row">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsFinalConceptAccPackDelete" name="myDesign" method="get">
		        			<div align="right">	        			
		        ...
		        <div class="col-md-2 col-sm-2">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsFinalConceptAccPackEdit" name="designerForm" method="get">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsFinalConceptAccPackAddNew">
		        			<div align="right">	        			
