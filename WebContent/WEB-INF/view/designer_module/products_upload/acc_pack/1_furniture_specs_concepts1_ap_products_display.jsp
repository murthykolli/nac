        ...
        <div class="col-md-6 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="center">
        			<p class="prod_uplod_disp_mana_for_Dsn">CONCEPT #1 - FURNITURE SPECS</p>
        			</div>
        ...
        <div class="col-md-6 col-sm-6">
	        <div class="row">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsConcepts1AccPackDelete" name="myDesign" method="get">
		        			<div align="right">	        			
		        ...
		        <div class="col-md-2 col-sm-2">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsConcepts1AccPackEdit" name="designerForm" method="get">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsConcepts1AccPackAddNew">
		        			<div align="right">	        			
