...
<html>    
    ...
    output.src = URL.createObjectURL(event.target.files[0]);
        ...
        <div class="col-md-12 col-sm-12">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="center">
        			<p class="prod_uplod_disp_for_Dsn">CONCEPT #1 - FURNITURE SPECS</p>
        			</div>        
        ...
        <form action="furnitureSpecsConcepts1AccPackProdSaving" name="fileUpload" method="post" enctype="multipart/form-data">        
        			...
        			<div align="center" class="prod_uplod_fur_spec_frame">
	        			...
	        			<table style="width: 720px;">
	        				<tbody>
	        					...
	        					<tr> <td class="prod_field_txt_disp_in_ds">&nbsp;&nbsp;</td> <td>&nbsp;<img class="desn_prod_file_upload_cl" id="output"/></td> </tr>
	        				</tbody>
	        			</table>				   
        			</div>        
                </div> <!-- /.service-description -->
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="furnitureSpecsCon1AccPackAddNewBackMove"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>
