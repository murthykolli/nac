...
<html>    
    ...
    $("#outputImageDisplayId").hide();    
        ...
        <div class="col-md-12 col-sm-12">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="center">
        			<p class="prod_uplod_disp_for_Dsn">Final Concept - FURNITURE SPECS</p>
        			</div>        
        ...
        <form action="furnitureSpecsFinalConceptAccPackEditedProdSaving" name="fileUpload" method="post" enctype="multipart/form-data">        
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="furnitureSpecsFinalConceptAccPackAddNewBackMove"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>
