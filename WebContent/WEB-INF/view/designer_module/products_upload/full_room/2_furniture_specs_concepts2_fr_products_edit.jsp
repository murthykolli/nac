...
<html>    
    ...
    $("#outputImageDisplayId").hide();    
        ...
        <form action="furnitureSpecsConcepts2FREditedProdSaving" name="fileUpload" method="post" enctype="multipart/form-data">        
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="furnitureSpecsCon2FRAddNewBackMove"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>
