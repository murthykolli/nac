        ...
        <div class="col-md-6 col-sm-6">
	        <div class="row">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsConcepts1FRDelete" name="myDesign" method="get">
		        			<div align="right">	        			
		        ...
		        <div class="col-md-2 col-sm-2">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsConcepts1FREdit" name="designerForm" method="get">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="furnitureSpecsConcepts1FRAddNew">
		        			<div align="right">	        			
