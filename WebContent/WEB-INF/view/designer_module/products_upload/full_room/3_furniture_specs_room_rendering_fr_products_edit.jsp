...
<html>    
    ...
    $("#outputImageDisplayId").hide();    
        ...
        <div class="col-md-12 col-sm-12">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="center">
        			<p class="prod_uplod_disp_for_Dsn">Room Rendering - FURNITURE SPECS</p>
        			</div>        
        ...
        <form action="furnitureSpecsRoomRenderingFREditedProdSaving" name="fileUpload" method="post" enctype="multipart/form-data">        
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="furnitureSpecsRoomRenderingFRAddNewBackMove"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>
