...
// Check Box Value Hold Functionality        
	...
	function typeOfFinishingTouches(finishingTouches) { 		
        ...
        <div class="container">
		        ...
		        <div class="col-md-9 col-sm-9">
		        	...
		        	<div class="row">
			        	<div class="col-md-12 col-sm-12">
					        ...
					        <td style="width: 530px;"><font id="checkBoxStyleLabelValId"></font></td> <td align="right" style="width: 120px;"><font style="font: bold 1.25em/0.9em Georgia;">${designerRegTotalResultCount}</font> <font style="text-transform: capitalize;">Results</font></td></tr></table>
	        ...
	        <form action="designerSelectedCBFinishingTouchesRed" id="selCheckBoxSubmitId" name="adminFTCBSelect" method="POST">
	        ...
	        <form action="designerUnCheckFinishingTouchesCheckBoxes" id="unCheckFinToucheseFormId" method="get">
                <input type="hidden" id="finishingTouchesRBNameId" name="finishingTouchesRBName" value="${finishingTouchesRBName}">                                
            </form>
        ...
        <form action="designerSelectedFinishingTouchesImageEdit" id="editImgsFTFormSubmitId" method="POST">		
			<input type="hidden" id="designerRegistryRoomId" name="designerRegistryRoom" value="${designerRegistryRoom}">
	        <input type="hidden" id="designerRegistryStyleId" name="designerRegistryStyle" value="${designerRegistryStyle}">
	        <input type="hidden" id="designerRegistryPriceId" name="designerRegistryPrice" value="${designerRegistryPrice}">
	        <input type="hidden" id="finishingTouchesRBNameId" name="finishingTouchesRBName" value="${finishingTouchesRBName}">
