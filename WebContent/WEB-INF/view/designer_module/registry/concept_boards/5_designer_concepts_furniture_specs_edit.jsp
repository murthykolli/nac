...
<html>    
	...
	<script type="text/javascript" src="resources/js/admin_reg_con_board_furniture_specs_edit_validation.js"></script>
	...
	$(document).ready(function(){
	    ...
	    /* alert("fileUploadName1: "+productUploadedImage11);
	   	alert("fileUploadName2: "+productUploadedImage12);
	   	alert("fileUploadName3: "+productUploadedImage13);
	   	alert("fileUploadName4: "+productUploadedImage14); */
	    
	    /* $("#productUploadedImage1").html(productUploadedImage11);
	    $("#productUploadedImage2").html(productUploadedImage12);
	    $("#productUploadedImage3").html(productUploadedImage13);
	    $("#productUploadedImage4").html(productUploadedImage14); */
        ...
        <div class="col-md-12 col-sm-12">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="center">
        			<p class="prod_uplod_disp_for_admcb">CONCEPT BOARDS - FURNITURE SPECS</p>
        			</div>        
        ...
        <form action="designerConFurnitureSpecsModifiedDataSaving" name="fileUpload" method="post" enctype="multipart/form-data">        
            	...
            	<div class="service-description">
        			<div align="center" class="prod_uplod_fur_spec_frame_for_admcb">
	        			...
	        			<table style="width: 860px;">
	        				<tbody>
	        					<tr> <td class="prod_field_txt_disp_for_admcb">PRODUCT NAME:</td> <td><input type="text" id="productNameId" maxLength="46" name="productName" placeholder="GREY DINING TABLE" class="prod_input_fild_disp_in_admcb"></td> </tr>
        ...
        <div class="col-md-5 col-sm-5">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="designerRedConFurnitureSpectsUpload"><img title="BACK" class="prod_upload_back_butt_adj_for_admcb" src="resources/images/backButton.png"></a>
        ...
        <div class="col-md-5 col-sm-5">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="right">	        			
						<h4><button class="admn_reg_cont_bd_submit_btn" id="admConFurnitureSpecsEditButtId">SAVE</button></h4>													   
        			</div>        
                </div> <!-- /.service-description -->
            </div> <!-- /.service-item -->               
        </div> <!-- /.col-md-4 -->
