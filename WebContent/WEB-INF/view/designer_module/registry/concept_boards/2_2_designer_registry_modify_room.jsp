...
<html>
	...
	// Sign Up keyboard validations
        		...
        		<div class="col-md-10 col-sm-10">
			        ...
			        <div class="row" style="margin-top: 50px;">	                
				        <div class="col-md-6 col-sm-6">
				        	<form action="designerConceptBoardsDataModification" method="post">		        	
				        	<table>		                                	
		...
		<form action="designerRedConceptSpcBoardModificationUpload" method="POST" enctype="multipart/form-data">
