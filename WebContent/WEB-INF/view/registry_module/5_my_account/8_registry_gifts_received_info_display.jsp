...
<!-- Guest Design Curated Finishing Touches Add Cart Coding -->						
		...
		%>
		<div class="row red_cart_guest_sub_div_bar" style="width: 800px; margin-left: 50px;"> <div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="concept_board_frame_cl"><img align="middle" src="<%=ftIndividualProductsImage%>" style="object-fit: scale-down; width: 100px;" ></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description" align="center">
		<div style="height: 100px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl concept_board_frame_cl"><%=guestFinTouchesPaymentNameList.get(i)%></div></div> </div> </div> </div> 								
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="my_acc_room_fund_bold_text_dsp concept_board_frame_cl">$<%=guestFinTouchesPaymentAmountList.get(i)%><%-- <font style="color: #696969;">/<%=guestFinTouchesPaymentQuantityList.get(i)%></font> --%></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=guestsFTNameList.get(i)%></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=guestFinTouchesPaymentStartDateList.get(i)%></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<% if(("No Action").equals(guestFTIndGiftRecStatus)) { %>
		<div style="height: 50px; margin-top: 22px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><form action="guestMAFTIndividualShopNow"><button class="reg_transfer_now_subt_Btn" onclick="return confirm('Please confirm that you would like us to place the order for this gift at this time.');">Ship Now</button> <input type="hidden" name="guestFTIndividualShopNowRef" value="<%=guestFinTouchesPaymentIdsList.get(i)%>"> </form> </div></td> <td></td> </tr>
		<tr style="height: 20px;"><td></td></tr>
	    <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><a href="guestMAFTIndividualConToStoreCredit?regConToStoreCreditRef=<%=guestFinTouchesPaymentIdsList.get(i)%>" class="convert_to_store_credit_cl" onclick="return confirm('Please confirm that you would like to convert the total gift amount to store credit at this time.');">Convert&nbsp;&nbsp;To <br>Store&nbsp;&nbsp;Credit</a></div></td>
		<td style="position: relative; left: 10px; top: -55px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -40px;"> You can request to have your gift shipped now or you can convert the gift amount to store credit that can be used on Nook+Cove for any product at any time. </span></div> </td> </tr> </tbody> </table> </div>
		<% } else if(("Converted to Store Credit").equals(guestFTIndGiftRecStatus)) { %>
		<div style="height: 50px; margin-top: 48px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=guestFTIndGiftRecStatus%></div></td>
		<td style="position: relative; left: 10px; top: -45px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -20px;"> Your store credit details can be found under the 'Store Credit' tab under 'Gifts' to your left. </span>
		</div></td> </tr> </tbody> </table> </div>
		<% } else if(("Order Processing").equals(guestFTIndGiftRecStatus)) { %>
		<div style="height: 100px;"><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=guestFTIndGiftRecStatus%></div></div>
		...
		<div style="height: 50px; margin-top: 25px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=guestFTIndGiftRecStatus%>&nbsp;<%=gustGRBOTillDatesList.get(i)%> </div></td> <td></td> </tr>
		<tr style="height: 20px;"><td></td></tr>
	    <tr><td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><a href="guestMAFTIndividualConToStoreCredit?regConToStoreCreditRef=<%=guestFinTouchesPaymentIdsList.get(i)%>" class="con_still_date_dsp_cl" onclick="return confirm('Please confirm that you would like to convert the total gift amount to store credit at this time.');">Convert&nbsp;&nbsp;To <br>Store&nbsp;&nbsp;Credit</a></div></td>
		<td style="position: relative; left: 10px; top: -55px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -65px;"> This product is on back order till the date provided. You can either wait for the product to become available or you can convert the gift amount to store credit at this time to shop for something else. </span></div> </td> </tr> </tbody> </table> </div>
		...
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=guestFTIndGiftRecStatus%></div></td>
		<td style="position: relative; left: 10px; top: -100px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -65px;"> This product is no longer in stock therefore the gift amount has been converted into store credit. Generally we replace out of stock products with similar products that can be found in our Finishing Touches. </span> </div></td> </tr> </tbody> </table> </div>
		<% } %> </div> </div> </div> </div> 
		<% } %>
        <% } } } } } } } } } } } } } } } } } } %>
...
<!-- Registry Design Curated Finishing Touches Add Cart Coding -->			
		...
		%>
		<div class="row red_cart_guest_sub_div_bar" style="width: 800px; margin-left: 50px;"> <div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="concept_board_frame_cl"><img align="middle" src="<%=ftIndividualProductImage%>" style="object-fit: scale-down; width: 100px;" ></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description" align="center">
		<div style="height: 100px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=regFiniTouchesPaymentNameList.get(i)%></div></div> </div> </div> </div> 								
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="my_acc_room_fund_bold_text_dsp concept_board_frame_cl">$<%=regFiniTouchesPaymentAmountList.get(i)%><%-- <font style="color: #696969;">/<%=regFiniTouchesPaymentQuantityList.get(i)%></font> --%></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=registrantNamesList.get(i)%></div></div> </div> </div> </div>  
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=regFiniTouchesPaymentStartDateList.get(i)%></div></div> </div> </div> </div>  
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<% if(("No Action").equals(regFTIndGiftRecStatus)) { %>
		<div style="height: 50px; margin-top: 22px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><form action="registryMAFTIndividualShopNow"><button class="reg_transfer_now_subt_Btn" onclick="return confirm('Please confirm that you would like us to place the order for this gift at this time.');">Ship Now</button> <input type="hidden" name="registryFTIndividualShopNowRef" value="<%=regFiniTouchesPaymentIdsList.get(i)%>"> </form> </div></td> <td></td> </tr>
		<tr style="height: 20px;"><td></td></tr>
	    <tr><td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><a href="regMAFTIndividualConToStoreCredit?regConToStoreCreditRef=<%=regFiniTouchesPaymentIdsList.get(i)%>" class="convert_to_store_credit_cl" onclick="return confirm('Please confirm that you would like to convert the total gift amount to store credit at this time.');">Convert&nbsp;&nbsp;To <br>Store&nbsp;&nbsp;Credit</a></div></td>
		<td style="position: relative; left: 10px; top: -55px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -40px;"> You can request to have your gift shipped now or you can convert the gift amount to store credit that can be used on Nook+Cove for any product at any time. </span></div> </td> </tr> </tbody> </table> </div>					    
		<% } else if(("Converted to Store Credit").equals(regFTIndGiftRecStatus)) { %>
		<div style="height: 50px; margin-top: 48px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=regFTIndGiftRecStatus%></div></td>
		<td style="position: relative; left: 10px; top: -45px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -20px;"> Your store credit details can be found under the 'Store Credit' tab under 'Gifts' to your left. </span> </div></td> </tr> </tbody> </table> </div>
		<% } else if(("Order Processing").equals(regFTIndGiftRecStatus)) { %>
		<div style="height: 100px;"><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=regFTIndGiftRecStatus%></div></div>
		...
		<div style="height: 50px; margin-top: 25px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=regFTIndGiftRecStatus%>&nbsp;<%=regiGRBOTillDatesList.get(i)%> </div></td> <td></td> </tr>
		<tr style="height: 20px;"><td></td></tr>
	    <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><a href="regMAFTIndividualConToStoreCredit?regConToStoreCreditRef=<%=regFiniTouchesPaymentIdsList.get(i)%>" class="con_still_date_dsp_cl" onclick="return confirm('Please confirm that you would like to convert the total gift amount to store credit at this time.');">Convert&nbsp;&nbsp;To <br>Store&nbsp;&nbsp;Credit</a></div></td>
		<td style="position: relative; left: 10px; top: -55px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -65px;"> This product is on back order till the date provided. You can either wait for the product to become available or you can convert the gift amount to store credit at this time to shop for something else. </span></div> </td> </tr> </tbody> </table> </div>
...
<!-- Registry Design Curated Concept Boards Contribute Coding -->						
		...
		<div class="row" style="width: 800px; margin-left: 50px; border-bottom: 1px solid #696969; padding-top: 30px; padding-bottom: 20px;">
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description">
		<div style="height: 100px;"><div class="concept_board_frame_cl"><img align="middle" src="<%=ftContributedProductImage%>" style="object-fit: scale-down; width: 100px;" ></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description" align="center">
		<div style="height: 100px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=regFinTouchesContributePaymentNameList.get(i)%></div></div> </div> </div> </div> 
		<div class="col-md-2 col-sm-2"> <div class="service-item"> <div class="service-description" align="center">
		<div style="height: 100px;"><div class="my_acc_room_fund_bold_text_dsp concept_board_frame_cl">$<%=totalProductAmountSt%></div></div> </div> </div> </div> 							
		<div class="col-md-6 col-sm-6">
		...
		<div class="col-md-4 col-sm-4"> <div style="height: 40px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=regFullName%></div></div> </div> 
		<div class="col-md-4 col-sm-4"> <div style="height: 40px;"><div class="my_acc_room_fund_text_dsp concept_board_frame_cl"><%=regDate%></div></div> </div> 
		<div class="col-md-4 col-sm-4"> <% if(("Converted to Store Credit").equals(contributedFTStatusCh) && ("Converted to Store Credit").equals(contributedStatusRef)) { %>										
		<div style="height: 40px;"><div class="my_acc_room_fund_bold_text_dsp concept_board_frame_cl">
		<div style="margin-top: 0px; font: bold 0.97em/1.15em Georgia; white-space: nowrap; letter-spacing: 0px; text-transform: capitalize; color: #a0a0a0;">Store Credit</div>
		<div style="margin-top: 5px; color: #a0a0a0;">$<%=regGivenPriceSt%></div> </div></div>
		<% } else { contNoActionDsp = "No Action"; %>
		...
		<% } else { %>									
		<div style="height: 80px; margin-top: 25px; margin-bottom: 5px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><form action="regMAFTContributedShopNow"><button class="reg_transfer_now_subt_Btn" onclick="return confirm('Please confirm that you would like us to place the order for this gift at this time.');">Ship Now</button> <input type="hidden" name="regFTContributedShopNowRef" value="<%=regFinTouchesContributePaymentIdsList.get(i)%>"> </form> </div></td> <td></td> </tr>
		<tr style="height: 20px;"><td></td></tr>
		<tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><a href="regMAFTContributedConToStoreCredit?regConToStoreCreditRef=<%=regFinTouchesContributePaymentIdsList.get(i)%>" class="convert_to_store_credit_cl" onclick="return confirm('Please confirm that you would like to convert the total gift amount to store credit at this time.');">Convert&nbsp;&nbsp;To <br>Store&nbsp;&nbsp;Credit</a></div></td>
		<td style="position: relative; left: 10px; top: -55px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -40px;"> You can request to have your gift shipped now or you can convert the gift amount to store credit that can be used on Nook+Cove for any product at any time. </span></div> </td> </tr> </tbody> </table> </div>
		<% } } else if(("Order Processing").equals(contributedFTStatus)) { %>
		<div style="height: 35px;"><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=contributedFTStatus%></div></div>
		<% } else if(("Ordered").equals(contributedFTStatus)) { %>
		<div style="height: 30px;"><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=contributedFTStatus%></div></div>
		...
		<div style="height: 80px; margin-top: 25px; margin-bottom: 5px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=contributedFTStatus%>&nbsp;<%=regiContGRBOTillDatesList.get(i)%> </div></td> <td></td> </tr>
		<tr style="height: 20px;"><td></td></tr>
		<tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><a href="regMAFTContributedConToStoreCreditInBOTD?regConToStoreCreditRef=<%=regFinTouchesContributePaymentIdsList.get(i)%>" class="con_still_date_dsp_cl" onclick="return confirm('Please confirm that you would like to convert the total gift amount to store credit at this time.');">Convert&nbsp;&nbsp;To <br>Store&nbsp;&nbsp;Credit</a></div></td>
		<td style="position: relative; left: 10px; top: -55px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -65px;"> This product is on back order till the date provided. You can either wait for the product to become available or you can convert the gift amount to store credit at this time to shop for something else. </span></div> </td> </tr> </tbody> </table> </div>
		<% } else if((("Converted to Store Credit Due to Out of Stock").equals(contributedFTStatus))) { %>
		<div style="height: 60px; margin-top: 60px; margin-bottom: 5px;">
		<table> <tbody> <tr> <td><div class="my_acc_guest_rev_link_bold_text_dsp concept_board_frame_cl"><%=contributedFTStatus%></div></td>
		<td style="position: relative; left: 10px; top: -100px;"><div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer; " class="fa">&#xf059;</i>
		<span class="mytext" style="margin-top: -65px;"> This product is no longer in stock therefore the gift amount has been converted into store credit. Generally we replace out of stock products with similar products that can be found in our Finishing Touches. </span> </div></td> </tr> </tbody> </table> </div>
		<%  }  %>	
		</div> </div> </div> </div>
