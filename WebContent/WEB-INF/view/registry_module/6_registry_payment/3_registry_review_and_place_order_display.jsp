...
<html>
    ...
    <link rel="shortcut icon" href="resources/images/ico/favicon.ico" type="image/x-icon" />	
	    ...
	    <div align="left" class="red_my_cart_for_guest_ht_dsp">BILLING INFO&nbsp;&nbsp;&nbsp;<a href="registrantFundsCheckOutContact"><font class="shop_cart_rn_editl_text_dsp">EDIT</font></a></div>
		...
		<div align="left" class="red_my_cart_for_guest_ht_dsp">SHIPPING INFO&nbsp;&nbsp;&nbsp;<a href="registrantFundsCheckOutContact"><font class="shop_cart_rn_editl_text_dsp">EDIT</font></a></div>
	    <table style="margin-top: 20px;"> <tbody>
		...
		<tr> <td class="rg_bill_review_pl_ord_text_dis">${billCountry}</td> </tr>
		<tr> <td class="rg_bill_review_pl_ord_text_dis">${shipPhNumber}</td> </tr> </tbody> </table> </div> </div> </div> </div>
		...
		<tr><td align="left" class="reg_gf_pay_tbtext_red_dsp_dsp">&nbsp;TOTAL:</td> <td class="reg_gf_pay_tbtext_red_dsp_dsp" align="right">$${shoppingCartTotalAmountInSn}&nbsp;</td></tr>
		</table></div>
