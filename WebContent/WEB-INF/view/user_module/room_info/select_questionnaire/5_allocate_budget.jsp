...
<html>    
	...
	$(document).ready(function(){		
	    ...
	    $("#budgetId").click(function (){	    	
	    	$(".budget_text_sel_box").css("border-color","black");	    	
	    });
	    
	    var boxVal;
	    $(".budget_text_sel_box").click(function (){	    	
	    	$("[name=allocatedBudget]").val("");
	    	$(".budget_text_sel_box").css("border-color","red");
	    	boxVal = "NOT SURE YET";
	    });
    ...
    window.onload=function(){ window.history.forward(1); };    
		...
		<div class="row">
            <div class="col-md-12 col-sm-12">
                <form action="allocateBudget" name="myDesign" method="get">
                    <div class="text-center">
                        <h4>
                            <button class="continue_submit_Btn" id="budgetButtonId">CONTINUE</button>
                        </h4>
                    </div>
