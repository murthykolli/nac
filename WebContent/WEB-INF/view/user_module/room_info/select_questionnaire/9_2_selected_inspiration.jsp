...
<html>    
 ...
 // function for deleting image
    ...
    function newAjaxCall(deletedImage){    	
        ...
        <div class="col-md-6 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<form action="shareInspirationUpImg" name="fileUpload" method="post" enctype="multipart/form-data">                
        ...
        <div class="form-nav">
            <form action="shareInspImgBackMove" method="get">
                <h4><input class="back_submit_Btn" type="image" title="BACK"
                           src="resources/images/backButton.png"></h4>
            </form>
            <form action="shareInspirationDataSaving" name="myDesign" method="get">
                <h4>
                    <button class="continue_submit_Btn" id="shareInspButtonId">CONTINUE</button>
                </h4>
