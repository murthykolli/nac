...
<html>    
	...
	$(document).ready(function(){
        ...
        <div class="form-nav">
            <form action="typeOfColorBackMove" method="get">
                <h4><input class="back_submit_Btn" type="image" title="BACK"
                           src="resources/images/backButton.png"></h4>
            </form>
            <form action="feelAboutColorRedirection" name="myDesign" method="get">
                <h4>
                    <button class="continue_submit_Btn" id="colorButtonId">CONTINUE</button>
                </h4>
