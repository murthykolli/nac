...
<html>    
	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		...
 		/* $("#typeOfArtButtonId").click(function (){	
 	    var result = true;
 	    
 	    var otherValue = $("#otherId").val();
	    if(otherValue !== "") {
	    	document.myDesign.typeOfArt.value = $("#otherId").val();
	    } 
 	...
 	function typtOfArtAppeals(typeOfArt) { 		
        ...
        <div class="form-nav">
            <form action="typeOfArtBackMove" method="get">
                <h4><input class="back_submit_Btn" type="image" title="BACK"
                           src="resources/images/backButton.png"></h4>
            </form>
            <form action="typeOfArtDataSaving" name="myDesign" method="get">
                <h4>
                    <button class="continue_submit_Btn" id="typeOfArtButtonId">CONTINUE</button>
                </h4>
