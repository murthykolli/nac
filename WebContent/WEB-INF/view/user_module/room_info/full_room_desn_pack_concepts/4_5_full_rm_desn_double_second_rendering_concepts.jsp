...
<html>    
	...
	function newAjaxCon3RendCall(likeValue){
    	...
    	$.ajax({    		
			type : 'POST',
			url : "doubleSecRendLikeUpdate?status="+likeValue,
			dataType : 'json',
			async : true,
			cache: false,
        ...
        <div class="col-md-6 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<div align="left"><p class="concepts_dssl_text">2ND RENDERING</p></div>
        			</div> <!-- /.col-md-4 -->
        			...
        			<div class="col-md-4 col-sm-4">
        			<div align="left"><a href="fullRmDouble2ndRenderingViewShopProducts" class="concepts_links_ds">VIEW PRODUCTS</a></div>
        			</div> <!-- /.col-md-6 -->
        ...
        <div class="col-md-8 col-sm-8">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<p class="concpts_bottom_txt_dsp">DO YOU LOVE WHAT YOU SEE AND CAN'T WAIT TO</p>
        			<p class="concpts_bottom_txt_dsp">BRING YOUR SPACE TOGETHER? SHOP YOUR</p>
        			<p class="concpts_bottom_txt_dsp">ROOM TODAY!</p>        			        			        			
        			</div>
        			<form action="fullRmShopRedir">
        			<div class="text-center con_sub_butt_adjmnt" > <h4><button class="continue_submit_Btn" id="spaceButtonId">SHOP MY ROOM</button></h4> </div>
        			</form>
