...
<html>    
  ...
  <!-- Concept 1 Coding -->              	
        ...
        <div class="col-md-5 col-sm-5">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="right" class="fr_rend_side_box_dspy top_adjustment_80">
        			<p class="fr_rend_bottom_txt_dsp">GIVE AS MUCH FEEDBACK AS YOU WOULD LIKE</p>
        			<p class="fr_rend_bottom_txt_dsp">TO YOUR DESIGNER SO THAT THEY CAN</p>
        			<p class="fr_rend_bottom_txt_dsp">PERFECT AND REVISE YOUR RENDERING!</p>        			
        			</div>
        			<form action="fullRmDesnRenderingReqRevision">
        			<div class="text-center final_con_sub_butt_adjmnt" > <h4><button class="continue_submit_Btn" id="spaceButtonId">REQUEST REVISION</button></h4> </div>
        			</form>
        			
        			<div align="center" class="fr_rendr_or_adj top_adjustment_30">
        			<table>
        			<tr>
        			<td class="fr_rend_or_bars"></td>
        			<td class="fr_rend_or_txt_dsp">OR</td>
        			<td class="fr_rend_or_bars"></td>
        			</tr>
        			</table>
        			</div>
        			
        			<div align="right" class="fr_rend_side_box_dspy top_adjustment_10">
        			<p class="fr_rend_bottom_txt_dsp">DO YOU LOVE WHAT YOU SEE AND CAN'T</p>
        			<p class="fr_rend_bottom_txt_dsp">WAIT TO BRING YOUR SPACE TOGETHER?</p>
        			<p class="fr_rend_bottom_txt_dsp">SHOP YOUR ROOM TODAY!</p>        			
        			</div>
