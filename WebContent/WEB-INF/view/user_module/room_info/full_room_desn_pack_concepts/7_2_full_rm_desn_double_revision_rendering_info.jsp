...
<html>    
	...
	function newAjaxCon3RendCall(likeValue){
    	...
    	$.ajax({    		
			type : 'POST',
			url : "doubleRevisedRenderingLikeUpdate?status="+likeValue,
			dataType : 'json',
			async : true,
			cache: false,
        ...
        <div class="col-md-6 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<div class="col-md-4 col-sm-4">
        			<div align="left"><a href="fullRmDoubleRevisedRenderingViewShopProducts" class="concepts_links_ds">VIEW PRODUCTS</a></div>
        			</div> <!-- /.col-md-6 -->
