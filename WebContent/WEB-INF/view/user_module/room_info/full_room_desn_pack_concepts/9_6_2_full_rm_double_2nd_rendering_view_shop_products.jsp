        			...
        			<div class="row top_adjustment_10">
	        			<div class="col-md-6 col-sm-6">
				        	<div class="service-item">                        
				            	<div class="service-description">
				        			<div align="left">        			
				        				<form action="fullRmSecRendering" method="get">
...
<!-- Concept 18th row Image -->
    ...
    <form action="fullRm2ndDoubleRenderingProductAddToCart" name="popupProductsName" method="get" id="fullRmRenderingProductId">
