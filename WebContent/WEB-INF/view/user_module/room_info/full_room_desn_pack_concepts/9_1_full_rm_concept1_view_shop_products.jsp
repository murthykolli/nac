...
<html>    
	...
	$(document).ready(function(){
		$(".addCartToProductsClass").click(function(){
			...
			$("#fullRmConcept1ProductId").submit();
	    });		    
        			...
        			<div class="row top_adjustment_10">
	        			<div class="col-md-6 col-sm-6">
				        	<div class="service-item">                        
				            	<div class="service-description">
				        			<div align="left">        			
				        				<form action="fullRmConcepts" method="get">
...
<!-- Concept 18th row Image -->
    ...
    <form action="fullRmConcept1ProductAddToCart" name="popupProductsName" method="get" id="fullRmConcept1ProductId">
