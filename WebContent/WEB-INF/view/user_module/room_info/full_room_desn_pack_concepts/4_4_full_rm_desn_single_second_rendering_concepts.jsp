...
<html>    
  ...
  <!-- Concept 1 Coding -->              	
        <div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<div class="col-md-4 col-sm-4">
        			<div align="left"><a href="fullRmSingle2ndRenderingViewShopProducts" class="concepts_links_ds">VIEW PRODUCTS</a></div>
        			</div> <!-- /.col-md-6 -->
        ...
        <div class="col-md-5 col-sm-5">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="right" class="fr_rend_side_box_dspy top_adjustment_150">
