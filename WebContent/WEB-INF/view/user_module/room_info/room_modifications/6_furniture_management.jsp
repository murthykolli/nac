        ...
        <div class="col-md-5 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<textarea name="otherItems" id="otherItemsId" placeholder="OTHER THINGS I NEED ..." readonly class="cl_item_txt_input_boxs_dis" style="margin-top: 10px;"></textarea>
        			<div class="margin_top_adj_dis"><div class="top_on_input_box_text_dis">I ALREADY HAVE: </div></div>
        			<textarea name="alreadyHaveItems" id="alreadyHaveItemsId" placeholder="I ALREADY HAVE ..." readonly class="cl_item_txt_input_boxs_dis" style="margin-top: 10px;"></textarea>
        			</div>
        			
        			</div>
        			
        			<form action="furnitureModification" name="myDesign" method="get">
