...
<html>    
 ...
 // function for deleting image
    ...
    function newAjaxCall(deletedImage){    	
        ...
        <div class="col-md-6 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<form action="modClUploadImagesInDB" name="fileUpload" method="post" enctype="multipart/form-data">                
        ...
        <div class="form-nav">
            <form action="myRoomManagement" method="get">
                <h4><input class="modi_back_submit_Btn" type="image" title="BACK"
                           src="resources/images/backButton.png"></h4>
            </form>
            <form action="myRoomManagement" name="myDesign" method="get">
			<h4><button class="continue_submit_Btn" id="abtSpaceButtonId">SAVE</button></h4>
