...
<html>    
	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		var typeOfSpaceValue = '<c:out value="${typeOfSpaceVal}"/>';
 		if(typeOfSpaceValue !== "") {
 			$("[name=typeOfSpace]").val(typeOfSpaceValue);
 			$("#ROOM").css("color","red");
        ...
        <div class="col-md-5 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<div class="mod_cl_frm_dis"><input type="text" name="typeOfSpace" readonly class="mod_cl_input"></div>
        			</div>
        			
        			<form action="roomModification" name="myDesign" method="get">
