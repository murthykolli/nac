...
<html>    
	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		var typeOfStyleVal = '<c:out value="${typeOfStyleVal}"/>';
 		
 			$("[name=typeOfStyle]").val(typeOfStyleVal);
 			$("#STYLE").css("color","red");
 			$("#STYLE").css('border-bottom','1px solid red');
        ...
        <div class="col-md-5 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<div class="mod_cl_frm_dis"><input type="text" name="typeOfStyle" readonly class="mod_cl_input"></div>
        			</div>
        			
        			<form action="styleModification" name="myDesign" method="get">
