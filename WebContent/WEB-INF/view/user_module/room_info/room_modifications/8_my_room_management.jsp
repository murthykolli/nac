...
<html>    
	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		var moreAbSpace = '<c:out value="${moreAboutSpace}"/>';
 			
 			$("#MYROOM").css("color","red");
 			$("#MYROOM").css('border-bottom','1px solid red');
 			$("[name=moreAboutSpace]").val(moreAbSpace);
 		...
 		$("#ART").click(function (){
 	        ...
 	        var imgsLength = uploadedImage.length;
 	        
 	        var tab1 = $("#clSpaceImg1List");
 	        var tab2 = $("#clSpaceImg2List");
 	                                
 	        for (var i = 0; i < 4 && i < imgsLength; i++){
 	        if(uploadedImage[i] !== ""){
 	        var imageFormat = "data:image/jpg;base64," + uploadedImage[i];        
 	        var str = "<td> <div class='room_sml_prod_img_dsp_div_cls' style='margin-left: 20px'> <img src=" + imageFormat + " class='room_sml_prod_img_dsp_cls'></div> </td>";
 	        tab1.append(str);       
 	        }
 	        }        
        	...
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="center" class="quest_bord_frame">
        				<div align="left" class="cl_imgs_list1_dsp">       	
				        	<table id="clSpaceImg1List" style="margin-left: -10px; margin-top: 30px;"></table>
				        </div>
				        
				        <div align="left" class="cl_imgs_list2_dsp">       	
				        	<table id="clSpaceImg2List" style="margin-left: -10px;"></table>
				        </div>
        			
        				<div class="margin_top_adj_dis"><div class="top_on_input_box_text_dis">I NEED MY SPACE TO BE PET FRIENDLY: </div></div>
        				<textarea name="moreAboutSpace" id="moreAboutSpaceId" placeholder="I NEED MY SPACE TO BE PET FRIENDLY ..." readonly class="cl_item_txt_input_boxs_dis" style="margin-top: 10px; margin-bottom: 40px;"></textarea>
        			
        			</div>
        			
        			<form action="myRoomModification" name="myDesign" method="get">
