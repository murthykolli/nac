...
<html>    
	...
	$("#needSpaceButtonId").click(function (){		
		...
		<div class="services" align="center" style="margin-top: 30px; margin-left: 255px; margin-right: 255px;">        
        ...
        <div class="form-nav">
            <form action="furnitureManagement" method="get">
                <h4><input class="modi_back_submit_Btn" type="image" title="BACK"
                           src="resources/images/backButton.png"></h4>
            </form>
            <form action="furnitureManagement" name="myDesign" method="get">
			<h4><button class="continue_submit_Btn" id="needSpaceButtonId">SAVE</button></h4>
