...
<html>    
	...
	$(document).ready(function(){
        ...
        <div class="form-nav">
            <form action="dimensionsManagement" method="get">
                <h4><input class="modi_back_submit_Btn" type="image" title="BACK"
                           src="resources/images/backButton.png"></h4>
            </form>
            <form action="dimensionsManagement" name="myDesign" method="get">
                <h4>
                    <button class="continue_submit_Btn" id="dimentionButtonId">SAVE</button>
                </h4>
