	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		var shareYourInsp = '<c:out value="${shareInspiration}"/>';
 			...
 			$("#INSPIRATION").css("color","red");
 			$("#INSPIRATION").css('border-bottom','1px solid red');
 		...
 		var shUploadedImgs = '<c:out value="${shUploadedImgInDB}"/>'; 			
	        ...
	        var tab1 = $("#clShInspImg1List");
	        var tab2 = $("#clShInspImg2List");
            	...
            	<div class="service-description">
        			<div align="center" class="quest_bord_frame">
        				<div align="left" class="cl_imgs_list1_dsp">       	
				       		<table id="clShInspImg1List" style="margin-left: -10px; margin-top: 30px;"></table>
				    	</div>
				        
				        <div align="left" class="cl_imgs_list2_dsp">       	
				        	<table id="clShInspImg2List" style="margin-left: -10px;"></table>
				        </div>
				        <div class="margin_top_adj_dis"><div class="top_on_input_box_text_dis">PINTEREST BOARD URL: </div></div>
        				<textarea name="shareInspiration" id="shareInspirationId" readonly placeholder="PINTEREST BOARD URL" class="cl_item_txt_input_boxs_dis" style="margin-top: 10px; margin-bottom: 40px;"></textarea>
        			</div>
        			
        			<form action="inspirationModification" name="myDesign" method="get">
