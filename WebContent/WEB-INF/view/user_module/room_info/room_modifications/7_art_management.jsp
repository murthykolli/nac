...
<html>    
	...
	<!-- JS files -->
	<script type="text/javascript" src="resources/js/desn_profile_Img_resolution.js" ></script>    
	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		var typeOfApp = '<c:out value="${typeOfArt}"/>'; 		
 			$("[name=typeOfArt]").val(typeOfApp);
 			$("#ART").css("color","red");
 			$("#ART").css('border-bottom','1px solid red');
        ...
        <div class="col-md-5 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<div class="mod_cl_frm_dis"><input type="text" name="typeOfArt" readonly class="mod_cl_input"></div>
        			</div>
        			
        			<form action="artModification" name="myDesign" method="get">
