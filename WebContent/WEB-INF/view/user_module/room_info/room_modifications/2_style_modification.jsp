	...
	<script type="text/javascript">
 	$(document).ready(function(){
	    ...
	    if(otherValue !== "") {
 		...
 		/* if($("#typeOfStyleId").val() !== ""){ result = true;
 	    } else{ alert("Please select one style"); result=false; }  */
 		return result;
 		});
 	...
 	function typeOfStyle(styleName) { 		
        ...
        <div class="services">
        	<div class="service-item">                        
            	<div class="service-description"><div class="top_left_adj1">CLASSIC</div>
			        <div class="style" id="CLASSIC" onclick="typeOfStyle('CLASSIC');" ><img src="resources/images/style_images/classic.jpg" width="161" height="305"></div>
			        
			        <div align="center" class="top_adjustment_18"><a class="styleOfProductsPopupImg1 style_link_dis" href="#">&nbsp;EXPLORE&nbsp;</a></div>
         	   </div> <!-- /.service-description -->
            </div> <!-- /.service-item -->               
        
        	<div class="service-item">                        
            	<div class="service-description"><div class="top_left_adj2">MODERN</div>
			        <div class="style" id="MODERN" onclick="typeOfStyle('MODERN');" ><img src="resources/images/style_images/modern.jpg" width="161" height="305"></div>
			        
			        <div align="center" class="top_adjustment_18"><a class="styleOfProductsPopupImg2 style_link_dis" href="#">&nbsp;EXPLORE&nbsp;</a></div>        
                </div> <!-- /.service-description -->
            </div> <!-- /.service-item -->               
        
        	<div class="service-item">                        
            	<div class="service-description"><div class="top_left_adj3">ECLECTIC</div>
			        <div class="style" id="ECLECTIC" onclick="typeOfStyle('ECLECTIC');" ><img src="resources/images/style_images/eclectic.jpg" width="161" height="305"></div>
			        
			        <div align="center" class="top_adjustment_18"><a class="styleOfProductsPopupImg3 style_link_dis" href="#">&nbsp;EXPLORE&nbsp;</a></div>        
                </div> <!-- /.service-description -->
            </div> <!-- /.service-item -->               
        
        	<div class="service-item">                        
            	<div class="service-description"><div class="top_left_adj4">CONTEMPORARY</div>
			        <div class="style" id="CONTEMPORARY" onclick="typeOfStyle('CONTEMPORARY');" ><img src="resources/images/style_images/contemporary.jpg" width="161" height="305"></div>
			        
			        <div align="center" class="top_adjustment_18"><a class="styleOfProductsPopupImg4 style_link_dis" href="#">&nbsp;EXPLORE&nbsp;</a></div>        
                </div> <!-- /.service-description -->
            </div> <!-- /.service-item -->               
        
        	<div class="service-item">                        
            	<div class="service-description">
			        <div class="style-oth-box sty-box-frame"><input type="text" id="otherId" name="otherName" class="style_input_box" placeholder="OTHER" onclick="typeOfStyle('OTHER');"></div>
			        <div class="style-oth-box2 sty-top-adjust"><p onclick="typeOfStyle('NOT_SURE');">I'M NOT SURE<br>WHAT MY<br>DESIGN STYLE<br>IS</p></div>        
                </div> <!-- /.service-description -->
            </div> <!-- /.service-item -->               
        </div>
        ...
        <div class="form-nav">
            <form action="styleManagement" method="get">
                <h4><input class="modi_back_submit_Btn" type="image" title="BACK"
                           src="resources/images/backButton.png"></h4>
            </form>
            <form action="styleManagement" name="myDesign" method="get">
                <h4>
                    <button class="continue_submit_Btn" id="styleButtonId">SAVE</button>
                </h4>
        ...
        <p>CLASSIC DESIGN   :   A DESIGN STYLE THAT IS MORE TRADITIONAL YET TIMELESS IN ITS APPROACH.         PATTERNED AND LAYERED FABRICS, FINE CARVED WOOD FURNITURE AND SYMMETRY ARE ALL CHARACTERISTICS OF THIS STYLE.</p>
        <p>MODERN DESIGN   :   MODERN DESIGN IS ROOTED IN MINIMAL AND STREAMLINED FURNITURE WITH IMPORTANCE GIVEN TO FORM AND FUNCTION.      MID-CENTURY MODERN AND SCANDINAVIAN DESIGN FALL INTO THIS CATEGORY.</p>
        <p>CONTEMPORARY DESIGN :  BOLD DESIGN WITH CONSIDERATION FOR CURRENT TRENDS IS KEY WITH CONTEMPORARY DESIGN.          FURNITURE WITH CLEAN LINES LEND TO ACASUAL ATMOSPHERE THAT IS PREVALENT IN CONTEMPORARY DESIGN.</p>
        <p>ECLECTIC DESIGN  :   ECLECTIC STYLE BORROWS FROM A VARIETY OF DESIGN STYLES AND ERAS.        CURATING A SPACE WITH PATTERNS, TEXTURES AND COLORS THAT FLOW AND COMPLEMENT ONE ANOTHER IS KEY IN PERFECTING AN ECLECTIC SENSE OF STYLE.</p>
        </div>
