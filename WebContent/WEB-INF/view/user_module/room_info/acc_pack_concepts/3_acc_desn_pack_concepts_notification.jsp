        ...
        <div class="col-md-8 col-sm-8">
        	<div class="service-item">                        
            	<div class="service-description">
        			...
        			<p class="concpts_bottom_txt_dsp">YOUR DESIGNER HAS BEEN NOTIFIED,</p>
        			<p class="concpts_bottom_txt_dsp">YOUR REVISED CONCEPT WILL BE READY IN 3 BUSINESS DAYS!</p>
