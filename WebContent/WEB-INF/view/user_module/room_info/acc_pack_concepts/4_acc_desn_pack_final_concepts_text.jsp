...
<html>    
        ...
        <div class="col-md-6 col-sm-6">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
        			<p class="concpts_txt_dsp">IF YOU HAVE PROVIDED FEEDBACK ON YOUR INITIAL CONCEPTS AND REQUESTED A REVISION, YOUR FINAL CONCEPT SHOULD BE READY SOON!</p>
        			
        			<p class="concpts_txt_dsp">TAKE A LOOK AT OUR DESIGN PROCESS TIMELINE BELOW TO GET A BETTER IDEA ON WHEN YOUR CONCEPTS WILL BE READY.</p>        			
 ...
 <!-- Concepts text display dynamic code start --> 
	    ...
	    RECEIVE&nbsp; FINAL<br>REVISED&nbsp; CONCEPT&nbsp; &amp;<br>SHOP&nbsp; THE&nbsp; LOOK
	    </div>
	 	</div>
