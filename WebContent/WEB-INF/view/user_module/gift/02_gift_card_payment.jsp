        	...
        	<div class="service-item">                        
            	<div class="service-description">
			        ...
			        <div class="shpp_tbl_fld_disp">	        
			        	...
			        	<c:if test="${not empty paymentReturnStatus}"> <tr><td align="left"><img src="resources/images/warning.gif" alt="nookandcove warning" style="position: absolute;"> <font style="color: red; font: 1.1em/1.25em Georgia; letter-spacing: 2px;"> &nbsp;&nbsp;&nbsp;&nbsp; ${paymentReturnStatus}</font></td></tr> </c:if>
                        ...
                        <div id="promoCodeDisplayId">
                            <form action="promoCodePayInGiftCardRed">
                                <div class="rev_ord_promo_code_frm">
                                    ...
                                    <button class="payment_apply_sub_Btn" id="giftCardPayPromoCodeButtId">APPLY&nbsp; CODE
                                    </button>
                                    <div id="promoCodeStatusId" style="display: none;">
                                        <div class="pay_promo_error_text"><p>THE CODE YOU ENTERED IS NOT VALID OR HAS EXPIRED</p></div>
                                    </div>
                        ...
                        <form action="giftCardPaymentInfoSaving" name="myDesign" method="POST">
