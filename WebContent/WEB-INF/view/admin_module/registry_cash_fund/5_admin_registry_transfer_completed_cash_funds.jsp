      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 60px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td style="position: relative; left: 54px;"><a href="#"><font class="adm_cf_sub_header_red_text_dsp">Transfer Complete</font></a></td>
...
<!-- Guest Cash Funds Coding -->
	 		...
	 		<% 	String guestCashFundsPaymentInfo = (String)session.getAttribute("adminGuestTransferCompletedCashFund");	 		
...
<!-- Registrant Cash Funds Coding -->
	 		...
	 		<% 	String registrantCashFundsPaymentInfo = (String)session.getAttribute("adminRegistryTransferCompletedCashFund");	 		
