...
<html>
	...
	.total_cash_fund_amount_dsp { font: bold 1.35em/1.25em Georgia; letter-spacing: 2px; color: black; white-space: nowrap; width: 300px; text-align: right; }
      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 60px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td style="position: relative; left: 18px;"><a href="#"><font class="adm_cf_sub_header_red_text_dsp">Cleared Not Requested</font></a></td>
						<td style="position: relative; left: 36px;"><a href="adminCashFundTransferRequested"><font class="adm_cf_sub_header_black_text_dsp">Transfer Requested</font></a></td>
						...
						<td style="position: relative; left: 10px;"><div class="total_cash_fund_amount_dsp">Total: $${totalCashFundPrice}</div></td>				        
					</tr></table>					
			   	</div>
...
<!-- Cash FUnds Data Display Functionality -->
		...
		<div class="row" id="visibleMyOrderId" style="display: none;">
			<div class="col-md-12 col-sm-12">				
				...
				<div class="col-md-12 col-sm-12" style="border-bottom: 2px solid #999; padding-bottom: 10px;">
					<div class="row">
...
<!-- Guest Cash Funds Coding -->
	 		...
	 		<% 	String guestCashFundsPaymentInfo = (String)session.getAttribute("adminGuestClearedNotRequestedCashFundsPaymentInfo");	 		
...
<!-- Registrant Cash Funds Coding -->
	 		...
	 		<% 	String registrantCashFundsPaymentInfo = (String)session.getAttribute("adminRegistryClearedNotRequestedCashFundsPaymentInfo");	 		
