      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 60px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						<td><a href="#"><font  class="adm_cf_sub_header_red_text_dsp">Funds Pending</font></a></td>
...
<!-- Cash FUnds Data Display Functionality -->
		...
		<div class="row" id="visibleMyOrderId" style="display: none;">
			<div class="col-md-12 col-sm-12">				
			<form action="adminPendingCashFundsRequestSaving" method="POST" name="adminCashFundsName">					
...
<!-- Guest Cash Funds Coding -->
	 		...
	 		<% 	String guestCashFundsPaymentInfo = (String)session.getAttribute("adminGuestPendingCashFundsPaymentInfo");	 		
...
<!-- Registrant Cash Funds Coding -->
	 		...
	 		<% 	String registrantCashFundsPaymentInfo = (String)session.getAttribute("adminRegistryPendingCashFundsPaymentInfo");	 		
			...
			<div class="row top_adjustment_60">        		
				<div class="col-md-12 col-sm-12 text-center">
					<h4><button class="adm_sub_cash_fund_sub_butt" id="viewClientId" onclick="return pendingCashFundsInfo();">Funds Cleared</button></h4> 
				</div>
			</div>
