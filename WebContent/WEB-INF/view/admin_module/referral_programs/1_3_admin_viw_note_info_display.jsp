...
<html>    
	...
	.admin_reff_text_field_disp{ font: 1.45em/1.25em Georgia; letter-spacing: 1px; color: black; padding-left: 5px; }
	.admin_reff_big_text_field_disp{ font: 1.45em/1.25em Georgia; letter-spacing: 1px; color: black; margin-top: 6px; background-color: white; border: 1px solid #595959; padding: 15px; width: 700px; height: 250px; }
   	...
   	$(document).ready(function(){ 		
        ...
        <div class="container">
      		...
      		<div class="row" style="margin-top: -20px; margin-bottom: 50px;">
				...
				<div class="col-md-8 col-sm-8" align="center">				
					<table style="margin-top: 0px;"> 
		      			...
		      			<tr> <td align="left"><div class="admin_reff_big_text_field_disp">${adminReferralNote}</div></td> </tr>
		   	...
		   	<form action="adminViewNoteInfoBackMove" name="referralFormName">
	        ...
	        <div class="col-md-8 col-sm-8" align="center">
		        <table> <tbody>
			        <tr>
			        	<td><button class="referral_admin_submit_btn">Back</button></td>
					</tr>
				</tbody> </table>
