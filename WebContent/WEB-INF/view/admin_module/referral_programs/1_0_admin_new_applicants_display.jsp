      		...
      		<div class="row" style="margin-top: -20px; margin-bottom: 70px;">
				...
				<div class="col-md-8 col-sm-8">				
					<table style="margin-top: 0px;"> 
		      			<tr>
							<td align="left" style="position: relative; left: 180px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${adminNewApplicantsCount}</div></div></td>
					...
					<table style="margin-top: 6px;"> 
						<tr>
							<td><a href="adminNewApplicants"><font  class="shop_admin_sub_menu_red_btn">New Applicants</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <form action="adminViewNewApplicantsInfo" name="referralUserFormName" id="referralUserFormNameId" method="get">      
        <div class="row">
        <div class="col-md-2 col-sm-2"></div>
        
        <div class="col-md-8 col-sm-8">
        
        <display:table  id="insured_list"  class="tablesorter" name="adminNewApplicantsInfoSavingList" style="margin-top: 0px; margin-left: 0px; width: 750px;">
        ...
        <display:column style="width:250px;" property ="createdDate" title="Date" format="{0,date,MM/dd/yyyy}" />
        ...
        <table> <tbody>
        <tr>
		<td><button class="referral_admin_submit_btn" onclick="return viewDetails();">View Details</button></td>		
		</tr>
		</tbody> </table>
        ...
        var count = '<c:out value="${adminNewApplicantsCount}"/>';        
