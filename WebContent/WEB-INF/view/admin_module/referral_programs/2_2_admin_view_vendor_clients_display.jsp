...
<html>    
	...
	.admin_shop_reward_amouts_dsp { font: 500 1.3em/1.5em Verdana, sans-serif; letter-spacing: 1px; color: black; }
	.admin_shop_ref_cl_name_dsp { font: bold 1.7em/1.5em Verdana, sans-serif; letter-spacing: 1px; color: #1560ac; }
	</style>
		   	...
		   	<div class="row" style="margin-top: -20px; margin-bottom: 70px;">
      			...
      			<div align="left" class="col-md-4 col-sm-4">				
					<table style="margin-top: 0px;"> 
		      			<tr> <td><a href="#"><font class="shop_admin_sub_menu_red_btn">Vendor Clients</font></a></td> </tr>
						<tr> <td align="left" style="position: relative; top: 15px;"><div class="admin_shop_ref_cl_name_dsp">${referralUserFullName}</div></td> </tr>						
					</table>						            
				</div>
		
				<div align="right" class="col-md-4 col-sm-4">				
					<table style="margin-top: 0px;"> 
		      			<tr> <td align="right"><div class="admin_shop_reward_amouts_dsp">Visa Totals: $${totalVisaCardAmount}</div></td> </tr>
						<tr> <td align="right"><div class="admin_shop_reward_amouts_dsp">N+C Credit Totals: $${totalNookAndCoveAmount}</div></td> </tr>						
					</table>						            
				</div>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <display:table  id="insured_list"  class="tablesorter" name="adminViewVendorClientsInfoSavingList" style="margin-top: 0px; margin-left: 0px; width: 750px;">
        <display:column headerClass="sortDisabled" style="width: 50px;">            
        	<label> <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="referralUserId" value="${insured_list.registrantUserId}"/><span></span></label>        
        </display:column>
        <display:column style="width:100px;" property ="createdDate" title="Date" format="{0,date,MM/dd/yyyy}" />
        <display:column property ="regFirstName" title="Name" />
        <display:column property ="coRegFirstName" title="Rewards" />
        </display:table>
        ...
        <!-- <table> <tbody>
        <tr>
		<td><button class="referral_admin_submit_btn" onclick="return viewVendorDetails();">View Vendor Details</button></td>
		<td style="position: relative; left: 25px;"><button class="referral_admin_submit_btn" onclick="return viewVendorClients();">View Vendor Clients</button></td>		
		</tr>
		</tbody> </table> -->
        ...
        <form action="adminCurrentVendors"> 
         	<div align="center"> <button class="referral_admin_submit_btn">Back Move</button> </div>
        </form>   
        </div>
        ...
        var count = '<c:out value="${adminViewVendorClientsCount}"/>';        
