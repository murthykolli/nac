...
<html>    
	...
	<script type="text/javascript">
 	$(document).ready(function() {
 		...
 		if(vendorClientsRef1 == "Visa Gift Cards") {
 			alert("No Visa Gift Cards right now."); 			
 		}
 	}); 	
    </script>
      		...
      		<div class="row" style="margin-top: -20px; margin-bottom: 70px;">
				...
				<div class="col-md-8 col-sm-8">				
					...
					<table style="margin-top: 36px;"> 
						<tr>
							<td><a href="adminVisaGiftCards"><font class="shop_admin_sub_menu_red_btn" style="padding: 7px 83px;">New <font style="font-weight: bold;"> - ${adminNewVisaGiftCardsCount}</font></font></a></td>
							<td style="position: relative; left: 20px;"><a href="adminIssuedVisaGiftCards"><font class="shop_admin_sub_menu_btn" style="padding: 7px 77px;">Issued <font style="font-weight: bold;"> - ${adminIssuedVisaGiftCardsCount}</font></font></a></td>											        
						</tr>
					</table>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <form action="adminIssuedVisaGiftCardsInfo" name="referralUserFormName" id="referralUserFormNameId" method="get">      
        <div class="row">
        <div class="col-md-2 col-sm-2"></div>
        
        <div class="col-md-8 col-sm-8">
        
        <display:table  id="insured_list"  class="tablesorter" name="adminVisaGiftCardsInfoSavingList" style="margin-top: 0px; margin-left: 0px; width: 750px;">
        ...
        var count = '<c:out value="${adminNewVisaGiftCardsCount}"/>';        
