...
<html>    
	...
	.admin_reff_text_hd_disp{ font: bold 2em/1.25em Georgia; letter-spacing: 1px; color: black;  }
	...
	<script type="text/javascript">
 	$(document).ready(function(){ 		
        ...
        <div class="container" style="margin-top: -15px; margin-bottom: 50px;">
      		...
      		<div class="row">
      			<div class="col-md-12 col-sm-12"><div class="admin_reff_text_hd_disp" align="center">Vendor Details</div></div>
      		</div>
	        ...
	        <div class="col-md-8 col-sm-8" align="center">
		        <table> <tbody>
			        <tr>
			        <td> <td style="position: relative; left: 20px;"><form action="adminCurrentVendors"><button class="referral_admin_submit_btn">Back Move</button><input type="hidden" name="referralUserId" value="${referralUserId}"></form></td>
					</tr>
				</tbody> </table>
