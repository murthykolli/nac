...
<html>    
	...
	<script type="text/javascript">
 	$(document).ready(function() {
 		...
 		if(vendorClientsRef1 == "Issued Gift Cards") {
 			alert("No Issued Visa Gift Cards right now."); 			
 		}
 	}); 	
    </script>
				...
				<div class="col-md-8 col-sm-8">				
					<table style="margin-top: 0px;"> 
		      			<tr>
							...
							<td align="left" style="position: relative; left: 392px;"><div class="number_circle_format"><div class="number_circle_format_value">${adminCurrentVendorsCount}</div></div></td>
							<td align="left" style="position: relative; left: 551px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${adminVisaGiftCardsCount}</div></div></td>
						</tr>
					</table>
					...
					<table style="margin-top: 6px;"> 
						<tr>
							...
							<td style="position: relative; left: 20px;"><a href="adminCurrentVendors"><font class="shop_admin_sub_menu_btn">Current Vendors</font></a></td>
							<td style="position: relative; left: 40px;"><a href="adminVisaGiftCards"><font class="shop_admin_sub_menu_red_btn">Visa Gift Cards</font></a></td>				        
						</tr>
					</table>
					
					<table style="margin-top: 36px;"> 
						<tr>
							<td><a href="adminVisaGiftCards"><font class="shop_admin_sub_menu_btn" style="padding: 7px 83px;">New <font style="font-weight: bold;"> - ${adminNewVisaGiftCardsCount}</font></font></a></td>
							<td style="position: relative; left: 20px;"><a href="adminIssuedVisaGiftCards"><font class="shop_admin_sub_menu_red_btn" style="padding: 7px 77px;">Issued <font style="font-weight: bold;"> - ${adminIssuedVisaGiftCardsCount}</font></font></a></td>											        
						</tr>
					</table>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <display:table  id="insured_list"  class="tablesorter" name="adminIssuedVisaGiftCardsInfoSavingList" style="margin-top: 0px; margin-left: 0px; width: 750px;">
        <display:column headerClass="sortDisabled" style="width: 50px;">            
        	<label> <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="referralUserId" value="${insured_list.referralVisaCustomGiftCardInfoSavingId}"/><span></span></label>        
        </display:column>
        <display:column style="width:100px;" property ="createdDate" title="Date" format="{0,date,MM/dd/yyyy}" />
        <display:column property ="referralUserFullName" title="Name" />
        <display:column property ="status" title="Totals" />
        <display:column property ="referralUserEmail" title="Email" />
        <display:column style="width:150px;" property ="issuedDate" title="Issued Date" format="{0,date,MM/dd/yyyy}" />        
        </display:table>
        ...
        <!-- <table> <tbody>
        <tr>
		<td><button class="referral_admin_submit_btn" onclick="return viewIssued();">Issued</button></td>
		</tr>
		</tbody> </table> -->
        ...
        var count = '<c:out value="${adminIssuedVisaGiftCardsCount}"/>';        
        ...
        function viewIssued() {
	        ...
	        if(referralUserIds === ""){
	        	window.alert("Please select a visa gift cards.");
	        return false;
	        } 
        }
