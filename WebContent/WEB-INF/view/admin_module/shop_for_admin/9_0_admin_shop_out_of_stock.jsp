		   		...
		   		<div class="col-md-5 col-sm-5" align="right">
		   			<table> 
		      			<tr>
							...
							<td align="left" style="position: relative; left: -5px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${shopOutOfStockCount}</div></div></td>						
						</tr>
					</table>
		   			...
		   			<table style="margin-top: 6px;"> 
		   				<tr>
				        	...
				        	<td style="position: relative; left: 0px;"><a href="adminShopOutOfStock"><font  class="shop_admin_sub_menu_red_btn">Out of Stock</font></a></td>
						</tr>
					</table>
			   	</div>
		   	</div>
...
<!-- Gift Received Data Display Functionality -->
				...
				<div align="right">
					<table>
						<tr>
							...
							<td style="font: bold 1.35em/1.25em serif; letter-spacing: 2px; color: black;">&nbsp;${shopOutOfStockCount}</td>
						</tr>
					</table>
				</div>
			</div>
        ...
        <form action="adminShopOutOfStockViewDisplay" name="shopCBFormName" id="shopCBFormNameId" method="get">      
        ...
        var count = '<c:out value="${shopOutOfStockCount}"/>';        
