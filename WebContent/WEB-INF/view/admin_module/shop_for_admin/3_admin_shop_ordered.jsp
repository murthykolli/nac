				...
				<div class="col-md-7 col-sm-7">
					<table style="margin-top: 0px;"> 
		      			<tr>
							...
							<td align="left" style="position: relative; left: 250px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${shopOrderedCount}</div></div></td>
					...
					<table style="margin-top: 6px;"> 
						<tr>
							...
							<td style="position: relative; left: 20px;"><a href="adminShopOrdered"><font  class="shop_admin_sub_menu_red_btn">Ordered</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
				...
				<div align="right">
					<table>
						<tr>
							...
							<td style="font: bold 1.35em/1.25em serif; letter-spacing: 2px; color: black;">&nbsp;${shopOrderedCount}</td>
						</tr>
					</table>
				</div>
			</div>
        ...
        <form action="adminShopTrackingLink" name="shopCBFormName" id="shopCBFormNameId" method="get">      
        ...
        <table> <tbody>
        <tr>
		<td><button class="shop_admin_submit_btn" onclick="return enterTrackingLink();">Enter Tracking Link</button></td>		
		</tr>
		</tbody> </table>
        ...
        var count = '<c:out value="${shopOrderedCount}"/>';        
