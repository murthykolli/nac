			...
			<div class="col-md-12 col-sm-12"style="border: 2px solid #41719c; padding: 40px;">				
				...
				<div class="col-md-12 col-sm-12">
					<div style="margin-top: 50px; margin-bottom: 40px;" align="center">
						<table> <tbody>
							<tr>
								<td><div align="left" style="margin-left: -20px;"><a href="adminShopPurchases"> <img src="resources/images/backButton.png" style="position: relative; top: 3px;"> </a></div></td>
								<td><form action="adminShopOrderedStatusUpdate"><div align="left" style="margin-left: 15px;"><button class="reg_add_bank_acc_saving_subt_Btn" id="cfBankInfoSavingButtId">Order Placed</button></div> <input type="hidden" name="shopCBProductsManagementId" value="${shopCBProductsManagementId}"> </form></td>
								<td><form action="adminShopBackOrderedDateDisplay"><div align="left" style="margin-left: 20px;" align="left"><button class="reg_add_bank_acc_saving_subt_Btn" id="cfBankInfoSavingButtId">Back Ordered</button></div> <input type="hidden" name="shopCBProductsManagementId" value="${shopCBProductsManagementId}"> </form></td>
								<td><form action="adminShopOutOfStockDataDisplay"><div align="left" style="margin-left: 20px;" align="left"><button class="reg_add_bank_acc_saving_subt_Btn" id="cfBankInfoSavingButtId">Out of Stock</button></div> <input type="hidden" name="shopCBProductsManagementId" value="${shopCBProductsManagementId}"> </form></td>
							</tr>
						</tbody></table>
					</div>
