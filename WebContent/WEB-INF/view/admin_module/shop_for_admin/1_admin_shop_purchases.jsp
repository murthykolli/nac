...
<html>    
	...
	.shop_admin_submit_btn:hover { background-color: red; color: white; cursor: pointer; }
      		...
      		<div class="row" style="margin-top: 0px; margin-bottom: 70px;">        
				<div class="col-md-7 col-sm-7">				
					<table style="margin-top: 0px;"> 
		      			<tr>
							<td align="left" style="position: relative; left: 120px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${shopPurchasesCount}</div></div></td>
					...
					<table style="margin-top: 6px;"> 
						<tr>
							<td><a href="adminShopPurchases"><font  class="shop_admin_sub_menu_red_btn">Purchases</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
				...
				<div align="right">
					<table>
						<tr>
							...
							<td style="font: bold 1.35em/1.25em serif; letter-spacing: 2px; color: black;">&nbsp;${shopPurchasesCount}</td>
						</tr>
					</table>
				</div>
			</div>
        ...
        <form action="adminShopPlaceOrderData" name="shopCBFormName" id="shopCBFormNameId" method="get">      
        ...
        <table> <tbody>
        <tr>
		<td><button class="shop_admin_submit_btn" onclick="return placeOrder();">Place Order</button></td>		
		</tr>
		</tbody> </table>
        ...
        var count = '<c:out value="${shopPurchasesCount}"/>';        
