...
<html>    
	...
	a.track_link_cl { font: italic 1.2em/1.25em Georgia; color: #1560ac; text-decoration: underline; background: white; width: 150px; padding: 24px 50px; }
				...
				<div class="col-md-7 col-sm-7">
					<table style="margin-top: 0px;"> 
		      			<tr>
							...
							<td align="left" style="position: relative; left: 380px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${shopTrackingCount}</div></div></td>
					...
					<table style="margin-top: 6px;"> 
						<tr>
							...
							<td style="position: relative; left: 40px;"><a href="adminShopTracking"><font  class="shop_admin_sub_menu_red_btn">Tracking</font></a></td>
		   		...
		   		<div class="col-md-5 col-sm-5" align="right">
		   			<table> 
		      			<tr>
		      				<td align="left" style="position: relative; left: -180px;"><div class="number_circle_format"><div class="number_circle_format_value">${shopBackOrderedCount}</div></div></td>
		   			...
		   			<table style="margin-top: 6px;"> 
		   				<tr>
				        	<td style="position: relative; left: -20px;"><a href="adminShopBackOrdered"><font  class="shop_admin_sub_menu_btn">Back Ordered</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
				...
				<div align="right">
					<table>
						<tr>
							...
							<td style="font: bold 1.35em/1.25em serif; letter-spacing: 2px; color: black;">&nbsp;${shopTrackingCount}</td>
						</tr>
					</table>
				</div>
			</div>
        ...
        <form action="adminShopDeliveredDataUpdate" name="shopCBFormName" id="shopCBFormNameId" method="get">      
        ...
        <display:column property ="trackingLink" title="Tracking Link" />
        </display:table>
        ...
        <table> <tbody>
        <tr>
		<td><button class="shop_admin_submit_btn" onclick="return delivered();">Delivered</button></td>		
		</tr>
		</tbody> </table>
        ...
        var count = '<c:out value="${shopTrackingCount}"/>';        
