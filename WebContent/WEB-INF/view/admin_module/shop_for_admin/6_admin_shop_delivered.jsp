				...
				<div class="col-md-7 col-sm-7">
					<table style="margin-top: 0px;"> 
		      			<tr>
							...
							<td align="left" style="position: relative; left: 520px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${shopDeliveredCount}</div></div></td>
						</tr>
					</table>
					...
					<table style="margin-top: 6px;"> 
						<tr>
							...
							<td style="position: relative; left: 60px;"><a href="adminShopDelivered"><font  class="shop_admin_sub_menu_red_btn">Delivered</font></a></td>				        
						</tr>
					</table>
			   	</div>		   	
...
<!-- Gift Received Data Display Functionality -->
				...
				<div align="right">
					<table>
						<tr>
							...
							<td style="font: bold 1.35em/1.25em serif; letter-spacing: 2px; color: black;">&nbsp;${shopDeliveredCount}</td>
						</tr>
					</table>
				</div>
			</div>
        ...
        <form action="adminShopDelivered" name="shopCBFormName" id="shopCBFormNameId" method="get">      
        ...
        var count = '<c:out value="${shopDeliveredCount}"/>';        
