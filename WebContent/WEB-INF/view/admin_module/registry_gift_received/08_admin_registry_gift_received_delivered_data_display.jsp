...
<html>    
	...
	a.track_link_cl { font: italic 1.3em/1.25em Georgia; color: #1560ac; text-decoration: underline; background: white; width: 150px; padding: 28px 60px; }
      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 50px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td align="right" style="position: relative; left: 440px;"><div class="number_circle_gc_format_mo"><div class="number_circle_format_value">${giftRecDeliveredCount}</div></div></td>
						...
						<td align="right" style="position: relative; left: 690px;"><div class="number_circle_format"><div class="number_circle_format_value">${giftRecOutOfStockCount}</div></div></td>
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td style="position: relative; left: 60px;"><a href="#"><font class="adm_gift_rec_sub_header_red_text">Delivered</font></a></td>				        
						...
						<td style="position: relative; left: 90px;"><a href="adminGiftsReceivedOutOfStock"><font class="adm_gift_rec_sub_header_black_text">Out of Stock</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <form action="adminGiftReceivedDeliveredDataUpdate" name="giftReceivedFormName" id="giftReceivedFormNameId" method="get">      
        <div class="row top_adjustment_20">
        
        <div class="col-md-12 col-sm-12">
        
        <display:table  id="insured_list"  class="tablesorter" name="totalCBGiftReceivedDeliveredDataList" style="margin-top: 0px; margin-left: 0px; min-width: 1120px;">
        <display:column headerClass="sortDisabled">            
        <%-- <label> <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="admConBoardManagementId" value="${insured_list.adminRegistryConceptBoardsFurnitureSpecsSavingId}"/><span></span></label> --%>
        <display:column property ="quantity" title="" style="width:50px; font: bold 1.1em/1.25em sans-serif;" /> 
        </display:column>
        ...
        <table> <tbody>
        <tr>
		<!-- <td><button class="adm_ar_submit_butt_dsp" onclick="return delivered();">Delivered</button></td> -->		
		</tr>
		</tbody> </table>
        ...
        function delivered(){
	        ...
	        if(giftReceivedManagementIds === ""){
	        	window.alert("Please select an order funds.");
	        return false;
	        } 
        }
