      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 50px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td align="right" style="position: relative; left: 340px;"><div class="number_circle_gc_format_mo"><div class="number_circle_format_value">${giftRecTrackingCount}</div></div></td>
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td style="position: relative; left: 45px;"><a href="#"><font class="adm_gift_rec_sub_header_red_text">Tracking</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <form action="adminGiftReceivedOrderedDataUpdate" name="giftReceivedFormName" id="giftReceivedFormNameId" method="get">      
        <div class="row top_adjustment_20">
        
        <div class="col-md-12 col-sm-12">
        
        <display:table  id="insured_list"  class="tablesorter" name="totalCBGiftReceivedTrackingDataList" style="margin-top: 0px; margin-left: 0px; min-width: 1120px;">
        ...
        <display:column property ="trackingLink" style="width:150px; background: white;" title="Tracking Link" />
        </display:table>
