      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 50px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						<td align="right" style="position: relative; left: 50px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${giftRecNoActionCount}</div></div></td>
					...
					<table style="margin-top: 12px;"> <tr>
						<td><a href="#"><font  class="adm_gift_rec_sub_header_red_text">No Action</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <display:table  id="insured_list"  class="tablesorter" name="totalCBGiftReceivedNoActionSavingList" style="margin-top: 0px; margin-left: 0px; min-width: 1120px;">
