      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 50px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td align="right" style="position: relative; left: 155px;"><div class="number_circle_gc_format_mo"><div class="number_circle_format_value">${giftRecOrderProcessingCount}</div></div></td>
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td style="position: relative; left: 15px;"><a href="#"><font class="adm_gift_rec_sub_header_red_text">Ship Now</font></a></td>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <form action="giftReceivedShipNowSelectedOrder" name="giftReceivedFormName" id="giftReceivedFormNameId" method="get">      
        <div class="row top_adjustment_20">
        
        <div class="col-md-12 col-sm-12">
        
        <display:table  id="insured_list"  class="tablesorter" name="totalCBGiftReceivedShopNowDataList" style="margin-top: 0px; margin-left: 0px; min-width: 1120px;">
        ...
        <table> <tbody>
        <tr>
		<td><button class="adm_ar_submit_butt_dsp" onclick="return placeOrder();">Place Order</button></td>		
		</tr>
		</tbody> </table>
        ...
        function placeOrder(){
	        ...
	        if(giftReceivedManagementIds === ""){
	        	window.alert("Please select an order Processing funds.");
	        return false;
	        } 
        }
