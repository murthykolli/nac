				...
				<div class="row">
					...
					<table> <tbody>
						<tr>
							...
							<td><form action="adminGROrderPlaceStatusUpdate"><div align="left" style="margin-left: 15px;"><button class="reg_add_bank_acc_saving_subt_Btn" id="cfBankInfoSavingButtId">Order Placed</button></div> <input type="hidden" name="giftReceivedManagementId" value="${giftReceivedManagementId}"> <input type="hidden" name="bothCBAndFTRefName" value="${bothCBAndFTRefName}"> </form></td>
							<td><form action="adminGRBackOrderedDateDisplay"><div align="left" style="margin-left: 20px;" align="left"><button class="reg_add_bank_acc_saving_subt_Btn" id="cfBankInfoSavingButtId">Back Ordered</button></div> <input type="hidden" name="giftReceivedManagementId" value="${giftReceivedManagementId}"> <input type="hidden" name="bothCBAndFTRefName" value="${bothCBAndFTRefName}"> </form></td>
							<td><form action="adminGROutOfStockStatusUpdate"><div align="left" style="margin-left: 20px;" align="left"><button class="reg_add_bank_acc_saving_subt_Btn" id="cfBankInfoSavingButtId">Out of Stock</button></div> <input type="hidden" name="giftReceivedManagementId" value="${giftReceivedManagementId}"> <input type="hidden" name="bothCBAndFTRefName" value="${bothCBAndFTRefName}"> </form></td>
						</tr>
					</tbody></table>
					</div>
