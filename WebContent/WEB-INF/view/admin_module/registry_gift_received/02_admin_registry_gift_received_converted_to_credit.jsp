      		...
      		<div class="row" style="margin-top: 10px; margin-bottom: 50px;">        
				<div class="col-md-12 col-sm-12">
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td align="right" style="position: relative; left: 850px;"><div class="number_circle_format_mo"><div class="number_circle_format_value">${giftRecCTStoreCreditCount}</div></div></td>						
					</tr></table>
					...
					<table style="margin-top: 12px;"> <tr>
						...
						<td style="position: relative; left: 105px;"><a href="#"><font class="adm_gift_rec_sub_header_red_text">Converted to Credit</font></a></td>
					</tr></table>					
			   	</div>		   	
		   	</div>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <display:table  id="insured_list"  class="tablesorter" name="totalCBGiftReceivedStoreCreditSavingList" style="margin-top: 0px; margin-left: 0px; min-width: 1120px;">
