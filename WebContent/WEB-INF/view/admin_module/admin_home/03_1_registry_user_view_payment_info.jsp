...
<html>    
    ...
    $(document).ready(function(){    	        
    	var totalPrice = '<c:out value="${regTotalAmount}"/>';
 		...
 		var fullRoomDesignDisplay = "<c:out value="${regFullRoomCount}"/>";
 		...
 		var accDesignDisplay = "<c:out value="${regAccPackCount}"/>";
 		if(accDesignDisplay !== ""){
 		...
 		var cashFundDisplay = "<c:out value="${regCashFundPrice}"/>";
 		if(cashFundDisplay !== ""){
        ...
        <div class="adm_reg_paym_txt_dsp">${regBillFullName}</div>
        <div class="adm_reg_paym_txt_dsp">${regPayAddress}</div>
        <div class="adm_reg_paym_txt_dsp">${regStAddress}</div>
        <div class="adm_reg_paym_txt_dsp">${regCountry}</div>       
        <div class="adm_reg_paym_txt_dsp">${regBillPhNumber}</div>
        </div>
        
        <div class="col-md-3 col-sm-3" style="border-right: 1px solid black;">
        <div style="margin-left: 10px;">
        <div class="adm_reg_paym_hd_txt_dsp">PAYMENT METHOD</div>        
        <div class="adm_reg_paym_txt_dsp">${regNameOnCard}</div>
        <div class="adm_reg_paym_txt_dsp">${regAccountType}</div>
        <div class="adm_reg_paym_txt_dsp">${regPayCardNumber}</div>
        <div class="adm_reg_paym_txt_dsp">${regPayExpDate}</div>
        ...
        <div class="adm_reg_paym_txt_dsp">${regMessage}</div>
        </div> 
        </div>         
        <div class="col-md-1 col-sm-1"></div> <!-- /.col-md-1 --> 
        </div> <!-- /.row -->
        ...
        <div class="col-md-1 col-sm-1"></div> <!-- /.col-md-1 -->
        <div class="col-md-3 col-sm-3" style="border-right: 1px solid black;">
        <div class="adm_reg_paym_txt_dsp">Transaction Number: <br>${regTransactionNo}</div>
        </div>
        
        <div class="col-md-3 col-sm-3" style="border-right: 1px solid black;">
        <div style="margin-left: 10px;">
        <div class="adm_reg_paym_txt_dsp">Authorization Code: <br>${regAuthorizeCode}</div>
        </div> 
        </div> 
        <div class="col-md-4 col-sm-4" style="border-left: 1px solid black; margin-left: -1px;">
        <div style="margin-left: 10px;">
        <div class="adm_reg_paym_txt_dsp">Payment Status: <br>${regCheckoutPaymentSt}</div>
        </div> 
        </div>         
        <div class="col-md-1 col-sm-1"></div> <!-- /.col-md-1 --> 
        </div> <!-- /.row -->
...
<!-- Cart Sub Heading -->
	        ...
	        <div class="row"><div class="red_my_cart_for_guest_div_bar"></div></div>
	 		...
	 		<% 	String regSelSpaceAllInfo = (String)session.getAttribute("regSelSpaceAllInfoInSn");	
...
<!-- Full Room Cart Sub Heading -->			
				...
				<div class="col-md-3 col-sm-3">
					<div class="service-item">                        
						<div class="service-description">
					    	<div align="center" class="red_my_cart_for_guest_reg_amt_dsp top_adjustment_10">&nbsp;&nbsp;&nbsp;$&nbsp;185/<font style="color: #696969;">${regFullRoomCount}</font></div>					    	
					   	</div> <!-- /.service-description -->
					</div> <!-- /.service-item -->               
				</div> <!-- /.col-md-3 -->
				</div> <!-- /.row -->
...
<!-- Acc Pack Cart Sub Heading -->			
				...
				<div class="col-md-3 col-sm-3">
					<div class="service-item">                        
						<div class="service-description">
					    	<div align="center" class="red_my_cart_for_guest_reg_amt_dsp top_adjustment_10">&nbsp;$&nbsp;85/<font style="color: #696969;">${regAccPackCount}</font></div>
					   	</div> <!-- /.service-description -->
					</div> <!-- /.service-item -->               
				</div> <!-- /.col-md-3 -->
				</div> <!-- /.row -->
...
<!-- Cash Fund Cart Sub Heading -->			
				...
				<div class="col-md-3 col-sm-3">
					<div class="service-item">                        
						<div class="service-description">
					    	<div align="center" class="red_my_cart_for_guest_reg_amt_dsp top_adjustment_10">$&nbsp;${regCashFundPrice}</div>
					   	</div> <!-- /.service-description -->
					</div> <!-- /.service-item -->               
				</div> <!-- /.col-md-3 -->
				</div> <!-- /.row -->
...
<!-- Cart Total Value Code -->
	 		...
	 		<div class="row top_adjustment_30">
				...
				<form action="adminRegistryUserPayment" method="get">
