				...
				<div class="col-md-6 col-sm-6">
					<div class="row">        
						<div class="col-md-12 col-sm-12" align="left">
					        <table> <tr>
						        <td><a href="registryLiveStatusRed"><font  class="adm_sub_reg_header_black_text_dsp">Live Clients - <font style="font: bold 1.0em/1.25em Georgia;">${adminRegLiveCount}</font></font></a></td>
							    <td style="position: relative; left: 18px;"><a href="#"><font class="adm_sub_reg_header_red_text_dsp">Archive Clients</font></a></td>							    				        
						    </tr></table>
					    </div>
					</div>
			   	</div>
...
<!-- Gift Received Data Display Functionality -->
        ...
        <form action="adminRegistryLiveStatusUpdate" name="registrantLoginInfoForm" id="registrantLoginInfoFormId" method="get">      
        <div class="row">
        
        <div class="col-md-12 col-sm-12">
        
        <display:table  id="insured_list"  class="tablesorter" name="adminRegistryArchiveStatusSavingList" style="margin-top: 0px; margin-left: 0px; min-width: 1155px;">
        ...
        <table> <tbody>
        <tr>
		<td><button class="adm_ar_submit_butt_dsp" onclick="return live();">Convert to Live</button></td>		
		</tr>
		</tbody> </table>
        ...
        var count = '<c:out value="${adminRegistryArchiveStatusListCount}"/>';        
