...
<html>
	...
	var usedGiftCount = '<c:out value='${usedGiftCardCount}'/>';
	...
	usedGiftCount = parseInt(usedGiftCount);
    ...
    RenderPieChart('container', [
				  ['Total Renderings', totGiftCards],                         
                  ['Full Room Design Package', fullRmCount],
                  ['Accessories Package', accPackCount],
                  ['Designers Count', usedGiftCount]
                  ]);     
	...
	<body>		
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">
                    <div align="right">
                    	<a href="secRenderingPaymentForAcc" class="admin_all_giftCard_info_dsp">ALL SECOND RENDERING INFO </a>
                    </div>
        ...
        <div><a href="allRenderingDailyReportsRed" class="selected_type_giftCard__dsp">DAILY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allRenderingWeeklyReportsRed" class="admin_all_giftCard_links_dsp">WEEKLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allRenderingMonthlyReportsRed" class="admin_all_giftCard_links_dsp">MONTHLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allRenderingQuarterlyReportsRed" class="admin_all_giftCard_links_dsp">QUARTERLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allRenderingYearlyReportsRed" class="admin_all_giftCard_links_dsp">YEARLY</a></div>
        </div>
        ...
        <div class="adm_new_cl_head_txt_dsp">SECOND RENDERING DAILY REPORTS</div>
        </div>
        	...
        	<div class="service-item">                        
            	<div class="service-description">
                    ...
                    <div align="center" style="display: none;" id="haveGiftCardsId">
                    	<div id="container" style="min-width: 280px; height: 280px; margin: 0 auto"></div>	                	                             
                    </div>
                    
                    <div align="center" style="display: none;" id="noGiftCardsId">
                    	<div class="no_giftcards_text_dsp">NO ONE CREATED SECOND RENDERING TODAY </div>	                	                             
                    </div>                     
