...
<html>
	...
	<body>		
        ...
        <div><a href="allShoppingCartDailyReportsRed" class="selected_type_giftCard__dsp">DAILY</a></div>
        </div>
        ...
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allShoppingCartQuarterlyReportsRed" class="admin_all_giftCard_links_dsp">QUARTERLY</a></div>
        </div>
        ...
        <div class="adm_new_cl_head_txt_dsp">SHOPPING CART DAILY REPORTS</div>
        </div>
        	...
        	<div class="service-item">                        
            	<div class="service-description">
                    ...
                    <div align="center" style="display: none;" id="noGiftCardsId">
                    	<div class="no_giftcards_text_dsp">NO ONE CREATED SHOPPING CART TODAY </div>	                	                             
                    </div>                     
