    ...
    if(typeOfDeliveryMethod === "Gift Box") {
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_gc_view_nrm_text_dsp">Package:</p> 
                	 <p class="admn_gc_view_nrm_text_dsp">Price:</p>
                	 <p class="admn_gc_view_nrm_text_dsp">Merchandise Credit:</p>
                	 <p class="admn_gc_view_nrm_text_dsp">Type Of Gift Card:</p>
                	 <p class="admn_gc_view_nrm_text_dsp">Your Email:</p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<p class="admn_gc_view_bold_text_dsp"><c:out value='${typeOfPackage}'/></p> 
                	<p class="admn_gc_view_bold_text_dsp"><c:out value='${packagePrice}'/></p>
                	<p class="admn_gc_view_bold_text_dsp"><c:out value='${merchandiseCredit}'/></p>
                	<p class="admn_gc_view_bold_text_dsp"><c:out value='${typeOfGiftcard}'/></p>
                	<p class="admn_gc_view_bold_text_dsp"><c:out value='${yourEmail}'/></p>   
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-7 -->
		...
		<div class="col-md-2 col-sm-2">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<form action="newGiftCardsForAcc" method="get">
