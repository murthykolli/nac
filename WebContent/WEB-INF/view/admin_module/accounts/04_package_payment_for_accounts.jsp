...
<html>    
    ...
    element.innerHTML = pagerHtml;
        ...
        <div class="adm_new_cl_head_txt_dsp" align="left">PACKAGE PAYMENT</div>
        </div>
        <div class="col-md-5 col-sm-5">
        ...
        <display:table  id="insured_list"  class="tablesorter" name="packagePaymentSavingList" style="margin-top: 0px; margin-left: 0px;">
        ...
        <display:column style="text-transform: uppercase;" property ="dislikeColor" title="DESIGNER STATUS"/>
		...
		<div class="col-md-11 col-sm-11">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<form action="allPackageDailyReportsRed" method="get">
        ...
        var count = '<c:out value="${packagePaymentListCount}"/>';        
