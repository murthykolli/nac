...
<html>
	...
	<body>		
        ...
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allPackageMonthlyReportsRed" class="selected_type_giftCard__dsp">MONTHLY</a></div>
        </div>
        ...
        <div class="adm_new_cl_head_txt_dsp">PACKAGE MONTHLY REPORTS</div>
        </div>
        	...
        	<div class="service-item">                        
            	<div class="service-description">
                    ...
                    <div align="center" style="display: none;" id="noGiftCardsId">
                    	<div class="no_giftcards_text_dsp">NO ONE CREATED PACKAGE THIS MONTH </div>	                	                             
                    </div>                     
