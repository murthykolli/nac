...
<html>
	...
	<body>		
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">
                    <div align="right">
                    	<a href="packagePaymentForAcc" class="admin_all_giftCard_info_dsp">ALL PACKAGE INFO </a>
                    </div>
        ...
        <div><a href="allPackageDailyReportsRed" class="selected_type_giftCard__dsp">DAILY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allPackageWeeklyReportsRed" class="admin_all_giftCard_links_dsp">WEEKLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allPackageMonthlyReportsRed" class="admin_all_giftCard_links_dsp">MONTHLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allPackageQuarterlyReportsRed" class="admin_all_giftCard_links_dsp">QUARTERLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allPackageYearlyReportsRed" class="admin_all_giftCard_links_dsp">YEARLY</a></div>
        </div>
        ...
        <div class="adm_new_cl_head_txt_dsp">PACKAGE DAILY REPORTS</div>
        </div>
        	...
        	<div class="service-item">                        
            	<div class="service-description">
                    ...
                    <div align="center" style="display: none;" id="noGiftCardsId">
                    	<div class="no_giftcards_text_dsp">NO ONE CREATED PACKAGE TODAY </div>	                	                             
                    </div>                     
