...
<html>
	...
	<body>		
        ...
        <div><a href="allGiftCardsDailyReportsRed" class="admin_all_giftCard_links_dsp">DAILY</a></div>
        </div>
        ...
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allGiftCardsQuarterlyReportsRed" class="selected_type_giftCard__dsp">QUARTERLY</a></div>
        </div>
        ...
        <div class="adm_new_cl_head_txt_dsp">GIFT CARDS QUARTERLY REPORTS</div>
        </div>
        	...
        	<div class="service-item">                        
            	<div class="service-description">
                    ...
                    <div align="center" style="display: none;" id="noGiftCardsId">
                    	<div class="no_giftcards_text_dsp">NO ONE CREATED GIFT CARDS THIS QUARTER </div>	                	                             
                    </div>                     
