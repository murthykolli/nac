...
<html>
	...
	<body>		
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">
                    <div align="right">
                    	<a href="newGiftCardsForAcc" class="admin_all_giftCard_info_dsp">ALL GIFT CARDS INFO </a>
                    </div>
        ...
        <div><a href="allGiftCardsDailyReportsRed" class="selected_type_giftCard__dsp">DAILY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allGiftCardsWeeklyReportsRed" class="admin_all_giftCard_links_dsp">WEEKLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allGiftCardsMonthlyReportsRed" class="admin_all_giftCard_links_dsp">MONTHLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allGiftCardsQuarterlyReportsRed" class="admin_all_giftCard_links_dsp">QUARTERLY</a></div>
        </div>
        
        <div class="col-md-2 col-sm-2" align="center">
        <div><a href="allGiftCardsYearlyReportsRed" class="admin_all_giftCard_links_dsp">YEARLY</a></div>
        </div>
        ...
        <div class="adm_new_cl_head_txt_dsp">GIFT CARDS DAILY REPORTS</div>
        </div>
        	...
        	<div class="service-item">                        
            	<div class="service-description">
                    ...
                    <div align="center" style="display: none;" id="noGiftCardsId">
                    	<div class="no_giftcards_text_dsp">NO ONE CREATED GIFT CARDS TODAY </div>	                	                             
                    </div>                     
