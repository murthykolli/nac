...
<html>    
    ...
    element.innerHTML = pagerHtml;
        ...
        <div class="adm_new_cl_head_txt_dsp" align="left">2ND RENDERING PAYMENT</div>
        </div>
        <div class="col-md-5 col-sm-5">
        <div class="adm_new_cl_sub_txt_dsp" align="right">Total payment items: <b id="displayCount" class="new_clients_no_dsp"></b></div>
        </div>
        ...
        <display:table  id="insured_list"  class="tablesorter" name="secnRendrPaymentSavingList" style="margin-top: 0px; margin-left: 0px;">
        <display:column headerClass="sortDisabled"><label>            
        <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="shopCartPaymentRef"/><span></span></label>
        </display:column>
        <display:column property ="createdDate" title="PURCHASE DATE" format="{0,date,MM/dd/yyyy}" />
        <display:column style="text-transform: uppercase;" property ="likeColor" title="CLIENT NAME"/>
        <display:column property ="designPackage" title="DESIGN PACKAGE"/>
        <display:column property ="typeOfSpace" title="ROOM"/>
        <display:column style="text-transform: uppercase;" property ="dislikeColor" title="DESIGNER NAME"/>
		...
		<div class="col-md-11 col-sm-11">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<form action="allRenderingDailyReportsRed" method="get">
        ...
        var count = '<c:out value="${secnRendrPaymentListCount}"/>';        
