...
<html>    
	...
	<script type="text/javascript">
 	$(document).ready(function(){
        ...
        modernInsTab.append("<td style='padding-right: 10px;'><img src=" + modenInspImage + " alt='' class='adminViewImgDsp inspiredImgs'></td>");
        }
        }
        modernInsTab.append("</tr>");  
        //for room images
        ...
        roomTab.append("<td style='padding-right: 10px;'><img src=" + uploadedSpImage + " alt='' class='adminViewImgDsp inspiredImgs'></td>");
        }
        }
        roomTab.append("</tr>");
        ...
        inspirationTab.append("<td style='padding-right: 10px;'><img src=" + uploadedInsImage + " alt='' class='adminViewImgDsp inspiredImgs'></td>");
        }
        }
        inspirationTab.append("</tr>");
...
/* Bigger Image Display */
		...
		<div class="col-md-10 col-sm-10">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrbold_text_dsp"><c:out value='${typeOfSpaceVal}'/></p>                	 
	                </div>
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrnrm_text_dsp">Style:</p> 
                	 <p class="admn_view_qrnrm_text_dsp">Packages:</p>
                	 <p class="admn_view_qrnrm_text_dsp">Budget:</p>
                	 <p class="admn_view_qrnrm_text_dsp">Room Dimensions:</p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${typeOfStyleVal}'/></p> 
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${designPackageVal}'/></p>
                	<p class="admn_view_qrbold_text_dsp">$<font id="budgetPriceId"></font></p>
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${aboutSpaceDimnVal}'/></p>   
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
        ...
        <div class="col-md-4 col-sm-4">
        	<div class="service-item">                        
            	<div class="service-description">                        
			        ...
			        <td><img class="desn_pro_img_reso_dsp_class" alt="" src="data:image/jpg;base64,<c:out value='${designerProfileImage}'/>" ></td></tr>
			        </table>   
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrnrm_text_dsp">Color:</p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${typeOfColor}'/></p>
                	<p class="admn_view_qrbold_text_dsp"><textarea name="likeColor" id="likeColorId" placeholder="COLORS I LOVE" class="aqr_color_tabox_disp"> </textarea></p>
                	<p class="admn_view_qrbold_text_dsp"><textarea name="dislikeColor" id="dislikeColorId" placeholder="COLORS I DISLIKE" class="aqr_color_tabox_disp"> </textarea></p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-7 -->
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrnrm_text_dsp">Furniture:</p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${allItemsVal}'/></p>
                	<p class="admn_view_qrbold_text_dsp"><textarea name="otherItems" id="otherItemsId" placeholder="OTHER THINGS I NEED ..." class="aqr_color_tabox_disp"> </textarea></p>
                	<p class="admn_view_qrbold_text_dsp"><textarea name="alreadyHaveItems" id="alreadyHaveItemsId" placeholder="I ALREADY HAVE ..." class="aqr_color_tabox_disp"> </textarea></p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-7 -->
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrnrm_text_dsp">Art:</p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${artAppValue}'/></p>
                	</div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-7 -->
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrnrm_text_dsp">Room Images:<font id="spImgCountDivId" color="red" style="display: none;"><c:out value='${uploadPhForDesCount}'/></font></p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">                        
					...
					<p class="admn_view_qrbold_text_dsp"><textarea name="moreAboutSpace" id="moreAboutSpaceId" placeholder="I NEED MY SPACE TO BE PET FRIENDLY ..." class="aqr_color_tabox_disp"> </textarea></p>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-7 -->
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrnrm_text_dsp">Inspiration Images:<font id="insImgCountDivId" color="red" style="display: none;"><c:out value='${insUploadPhotoCount}'/></font></p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">                        
					...
					<p class="admn_view_qrbold_text_dsp"><textarea name="shareInspiration" id="shareInspirationId" placeholder="PINTEREST BOARD URL" class="aqr_color_tabox_disp"> </textarea></p>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-7 -->
		...
		<div class="col-md-3 col-sm-3">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	 <p class="admn_view_qrnrm_text_dsp">Client Asked Designer Name:</p>
                	 <p class="admn_view_qrnrm_text_dsp">How did you hear About Us?:</p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-3 -->
		...
		<div class="col-md-7 col-sm-7">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${clAskedDesignerName}'/></p>
                	<p class="admn_view_qrbold_text_dsp"><c:out value='${clHearAboutUs}'/></p>
	                </div>
            	</div> <!-- /.service-description -->
        	</div> <!-- /.service-item -->               
        </div> <!-- /.col-md-7 -->
		...
		<div class="col-md-10 col-sm-10">
        	<div class="service-item">                        
            	<div class="service-description">                        
                	<div align="left">
                	<form action="desDirQuestionairreBack" method="get">
