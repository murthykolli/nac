...
<html>    
    ...
    <link rel="shortcut icon" href="resources/images/ico/favicon.ico" type="image/x-icon">
        	...
        	<div class="service-item">                        
            	...
            	<div class="mess_head_tx_dspl">${designerFullName}</div>
            	  ...
            	  <div class="messages messages_display_frame_cl" id="messages">
					<table id="desnAndAdmnMessageId"></table>					
				  </div>
				  
				  <div class="message_type_display_box_cl">			
						<form action="adminMessageSendToDesigner" name="messageSending" method="post">
						<textarea  name="adminMessage" id="adminMessageForDesignerId" class="entry" placeholder="Type message here" style="font: 1.15em/1.25em Georgia; color: black; height: 108px;"></textarea>
		...
		<script type="text/javascript">
	 	...
	 	var adminAndDesMesList =  '<c:out value='${adminAndDesMessList}'/>';
	 	
	    var adminAndDesMes = adminAndDesMesList.split("_,_");
	    var mesInfoDisplayTab = $("#desnAndAdmnMessageId");
	    
	    for (var i = 0; i < adminAndDesMes.length; i++){
	    if(adminAndDesMes[i] !== ""){
	    	var adminAndDesMesg = adminAndDesMes[i];
	    	
	    	var designerAndAdminMesg1 = adminAndDesMesg.split(",_,");
	    	var designerAndAdminMesg2 = adminAndDesMesg.split("__");
		...
		$("#designerMesButtonId").click(function (){	
	        var result = true;
		if($("#adminMessageForDesignerId").val() !== ""){			
			result = true;
	        } else{ $("#adminMessageForDesignerId").css("border-color","red"); result=false;  } 
		return result;
		});
		
		document.messageSending.elements['adminMessage'].focus();
