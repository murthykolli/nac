...
<html>    
	...
	<script type="text/javascript" src="resources/js/admin_reg_con_board_furniture_specs_validation.js"></script>
        ...
        <form action="adminConFurnitureSpecsUploadDataSaving" name="fileUpload" method="post" enctype="multipart/form-data">        
        ...
        <div class="col-md-5 col-sm-5">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="adminConFurSpectsDataDisplayRed"><img title="BACK" class="prod_upload_back_butt_adj_for_admcb" src="resources/images/backButton.png"></a>
