...
<html>
	...
	<script type="text/javascript">
 	$(document).ready(function() {
	    ...
	    if($("#adminRegistryDesignerId").val() !== ""){ $("#adminRegistryDesignerLabelId").css("color","black");
	...
	// Sign Up keyboard validations
        	...
        	<div class="row">
        		...
        		<div class="col-md-10 col-sm-10">
			        ...
			        <div class="row" style="margin-top: 50px;">	                
				        <div class="col-md-6 col-sm-6">
				        	<form action="adminAddAnotherConceptBoards" method="post">		        	
				        	<table>		                                	
		...
		<form action="adminAddAnotherConceptSpcBoardUpload" method="POST" enctype="multipart/form-data">
