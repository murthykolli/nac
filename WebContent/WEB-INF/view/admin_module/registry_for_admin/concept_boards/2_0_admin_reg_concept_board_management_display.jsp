...
<html>    
    ...
    element.innerHTML = pagerHtml;
        ...
        <form action="adminRegConceptBoardsManagementRedirect" name="admConBoardMant" id="admConBoardMantId" method="get">      
        <div class="row top_adjustment_30">
        
        <div class="col-md-12 col-sm-12">
        
        <display:table  id="insured_list"  class="tablesorter" name="adminRegConceptBoardsManagementSavingList" style="margin-top: 0px; margin-left: 0px; min-width: 1120px;">
        ...
        var count = '<c:out value="${adminRegConceptBoardsManagementListCount}"/>';        
