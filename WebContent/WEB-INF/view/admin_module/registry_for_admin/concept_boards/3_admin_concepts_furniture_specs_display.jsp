    ...
    $("#furnitureSpecsEditButId").click(function(){
        ...
        <div class="col-md-2 col-sm-2">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="adminConFurnitureSpecsDisplayBack"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>
        ...
        <div class="col-md-6 col-sm-6">
	        <div class="row">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="adminConFurnitureSpecsDataDelete" name="myDesign" method="get">
		        			<div align="center">	        			
		        ...
		        <div class="col-md-3 col-sm-3">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="adminRedConFurnitureSpectsEditProducts" name="designerForm" method="get">
		        			<div align="left">	        			
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="adminRedConFurnitureSpectsAddNewProducts">
		        			<div align="right">	        			
