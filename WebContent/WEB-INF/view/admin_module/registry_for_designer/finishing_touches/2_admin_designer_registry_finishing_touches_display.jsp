    ...
    $("#furnitureSpecsApprovalButId").click(function(){
        			...
        			<div align="center" class="prod_uplod_fur_spec_display_frame_ardcfs">
        				...
        				<div class="row top_adjustment_10">
							...
							<% if (null != session.getAttribute("finishingTouchesIdList")) {
							   ...
							   if (null != session.getAttribute("finishingTouchesApprovedStatusList")) {
							   @SuppressWarnings("rawtypes")
							   ArrayList furnSpecApprovalStatusList = (ArrayList) session.getAttribute("finishingTouchesApprovedStatusList");
					        ...
					        <div class="col-md-8 col-sm-8">
					        	<div class="service-item">                        
					            	<div class="service-description">
					        			...
					        			<table> <tbody>
						        			<% for(int i=0;i<finishingTouchesIdsList.size(); i++) { String approvalStatus = ""; String apprlStatus = (String) furnSpecApprovalStatusList.get(i); if(null != apprlStatus) {approvalStatus = apprlStatus; } %>
						        			<tr><td style="padding-top: 5px;"><input class="radio_butt_adj_inprod_ardcfs" type="radio" id="productNameId" name="productName" value="<%=finishingTouchesIdsList.get(i)%>"><font class="prodct_text_display_in_ardcfs">&nbsp;&nbsp;PRODUCT NAME:</font>&nbsp;&nbsp;</td> <td class="prodc_value_text_display_in_ardcfs"><%=ftProductNameList.get(i)%></td>  <td class="prodc_appr_text_display_in_ardcfs"><%=approvalStatus%></td></tr>
						        			<% } %>
					        			</tbody></table>	        									   
					        			</div>        
					                </div> <!-- /.service-description -->
        ...
        <div class="col-md-2 col-sm-2">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="adminDesignerConcepts"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>
        ...
        <div class="col-md-6 col-sm-6">
	        <div class="row">
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="adminDesignerFinishingTouchesDataDelete" name="myDesign" method="get">
		        			<div align="center">	        			
		        ...
		        <div class="col-md-3 col-sm-3">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="adminDesignerFinishingTouchesEditProducts" name="designerForm" method="get">
		        			<div align="left">	        			
		        ...
		        <div class="col-md-4 col-sm-4">
		        	<div class="service-item">                        
		            	<div class="service-description">
		            		<form action="adminDesignerRedFinishingTouchesSpectsProdApproval" name="desAppForm" method="get">
		        			<div align="right">	        			
