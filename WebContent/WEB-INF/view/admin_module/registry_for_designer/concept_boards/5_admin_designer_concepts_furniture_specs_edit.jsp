...
<html>    
	...
	$(document).ready(function(){
        ...
        <form action="adminDesignerConFurnitureSpecsModifiedDataSaving" name="fileUpload" method="post" enctype="multipart/form-data">        
        ...
        <div class="col-md-5 col-sm-5">
        	<div class="service-item">                        
            	<div class="service-description">
        			<div align="left">
	        			<a href="adminDesignerRedConFurnitureSpectsUpload"><img title="BACK" class="prod_upload_back_butt_adj_for_admcb" src="resources/images/backButton.png"></a>
