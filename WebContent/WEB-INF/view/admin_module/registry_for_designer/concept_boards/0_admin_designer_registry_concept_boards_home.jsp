...
// Check Box Value Hold Functionality        
	...
	function typeOfFinishingTouches(finishingTouches) { 		
        ...
        <div class="container">
	        ...
	        <div class="row">        
		        ...
		        <div class="col-md-9 col-sm-9">
			        ...
			        <form action="adminDesignerConcepts">
		        	...
		        	<div class="row" style="margin-bottom: 25px;">
			        	<div class="col-md-12 col-sm-12">
					        ...
					        <td style="width: 170px; white-space: nowrap;"><font id="radioLabelNalId"></font></td> <td style="width: 570px;"><font id="checkBoxStyleLabelValId"></font> <font style="display: none; font: 1.3em/1.25em Georgia;" id="bothDisplayId">, </font> <font id="checkBoxPriceLabelValId" style="font: 1.3em/1.25em Georgia;"></font></td> <td align="right" style="width: 120px;"><font style="font: bold 1.25em/0.9em Georgia;">${adminDesignerRegTotalResultCount}</font> <font style="text-transform: capitalize;">Results</font></td>
					        </tr></table>
					...
					<% if (null != session.getAttribute("adminDesignerRegConBdRoomIdsListInSn")) {
					   @SuppressWarnings("rawtypes")
				       ArrayList desnRegConBdRoomIdsListInSn = (ArrayList) session.getAttribute("adminDesignerRegConBdRoomIdsListInSn");
				       if (null != desnRegConBdRoomIdsListInSn && desnRegConBdRoomIdsListInSn.size() > 0) {
						   
					   if (null != session.getAttribute("adminDesignerRegConBdRoomImagesListInSn")) {
					   @SuppressWarnings("rawtypes")
			           ArrayList desnRegConBdRoomImagesListInSn = (ArrayList) session.getAttribute("adminDesignerRegConBdRoomImagesListInSn");
	        ...
	        <form action="adminDesignerSelectedStyleAndRoomRed" id="styleImgsFormId" name="admStyleSelect" method="get">
	        ...
	        <form action="adminDesignerSelectedStyleRoomAndPriceRed" id="priceImgsFormId" name="admPriceSelect" method="get">
                <input type="hidden" id="designerRegistryRoomId" name="designerRegistryRoom" value="${designerRegistryRoom}">
	        ...
	        <form action="adminDesignerUnCheckStyleAndPriceBoxesRed" id="unCheckStyleAndPriceFormId" method="get">
                <input type="hidden" id="designerRegistryRoomId" name="designerRegistryRoom" value="${designerRegistryRoom}">                                
            </form>
        ...
        <form action="adminDesignerSelectedRoomAndStyleImageUpload" id="editImgsFormSubmitId" method="get">		
		<input type="hidden" id="designerRegistryRoomId" name="designerRegistryRoom" value="${designerRegistryRoom}">
