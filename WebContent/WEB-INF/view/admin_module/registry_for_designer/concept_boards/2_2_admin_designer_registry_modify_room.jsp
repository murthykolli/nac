...
<html>
	...
	// Sign Up keyboard validations
        	...
        	<div class="row">
        		...
        		<div class="col-md-10 col-sm-10">
			        ...
			        <div class="row" style="margin-top: 50px;">	                
				        <div class="col-md-6 col-sm-6">
				        	<form action="adminDesignerConceptBoardsDataModification" method="post">		        	
				        	<table>		                                	
				        ...
				        <div class="col-md-6 col-sm-6">
				        	...
				        	<div align="center" style="margin-top: 15px;">
				        	<form action="adminDesignerRedConFurnitureSpectsUpload">
		...
		<form action="adminDesignerRedConceptSpcBoardModificationUpload" method="POST" enctype="multipart/form-data">
