...
<html>
	...
	// Sign Up keyboard validations
        	...
        	<div class="row">
        		...
        		<div class="col-md-10 col-sm-10">
			        ...
			        <div class="row" style="margin-top: 50px;">	                
				        <div class="col-md-6 col-sm-6">
				        	<form action="designerAddAnotherConceptBoards" method="post">		        	
				        	<table>		                                	
					        ...
					        <td><select id="designerRegistryPriceId" name="designerRegistryPrice" class="adn_reg_add_boards_inpfield_dsp"> <option value=''> -------------- Select -------------- </option> <option value='2000 - 5000'>$1,500 - $5,000</option> <option value='5000 - 10000'>$5,000 - $10,000</option> <option value='10000+'>$10,000+</option> </select></td></tr>
							...
							<td>
					        <a href="designerRegAddNewBoards"><img title="BACK" class="prod_upload_back_butt_adj" src="resources/images/backButton.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;		
					        </td> 
		...
		<form action="designerAddAnotherConceptSpcBoardUpload" method="POST" enctype="multipart/form-data">
