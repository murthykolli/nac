...
<html>    
    ...
    element.innerHTML = pagerHtml;
        ...
        <div class="adm_new_cl_head_txt_dsp" align="left">NEW GIFT CARDS</div>
        </div>
        <div class="col-md-5 col-sm-5">
        <div class="adm_new_cl_sub_txt_dsp" align="right">Total new gift cards: <b id="displayCount" class="new_clients_no_dsp"></b></div>
        </div>
        ...
        <form action="giftCardInfoSharing" name="designerClients" id="designerClientsId" method="get">      
        <div class="row top_adjustment_10">
        <div class="col-md-1 col-sm-1">
        </div> <!-- /.col-md-1 -->        
        ...
        <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="giftCardId" value="${insured_list.giftCardInfoSavingId}"/><span></span></label>
        </display:column>
        ...
        <input type="hidden" name="giftCardType"/>
        </form>
        ...
        function view(){
        	document.designerClients.giftCardType.value = "View Giftcard";
	        var giftCardIds="";        
		        for(var k=0; k < document.designerClients.giftCardId.length; k++) {
			        if(document.designerClients.giftCardId[k].checked){
			        	giftCardIds=document.designerClients.giftCardId[k].value;        
			        }
		        }
	    
	        if(document.designerClients.giftCardId.checked){
	        	giftCardIds=document.designerClients.giftCardId.value;
	        }
        ...
        function deleteGiftCard(){
        	document.designerClients.giftCardType.value = "Delete Giftcard";
